...
class OduEncryption(YangBaseModel):
    ...
    odu_key_sync_session: str | str | None = Field(json_schema_extra={'is_config': True}, description='Indicate the associated session for the ODU channel to synchronize keys.', default='none', alias="odu-key-sync-session")
...
class OduItem(YangBaseModel):
    ...
    connected_interface: str | str | None = Field(json_schema_extra={'is_config': True}, default='none', alias="connected-interface")
...
class AmplifierItem(YangBaseModel):
    ...
    partner_amp: str | str | None = Field(json_schema_extra={'is_config': False}, description='The partner amplifier for in line amplifier working mode.', default='not-available', alias="partner-amp")
...
class ShelfItem(YangBaseModel):
    ...
    shelf_linklocal_ip_address: str | str | None = Field(json_schema_extra={'is_config': True}, description='The link local IP address of the shelf, which is used during the shelf topology establishment phase', default=None, alias="shelf-linklocal-ip-address")
    shelf_ip_address: str | str | None = Field(json_schema_extra={'is_config': True}, description='The IP address of the shelf, which is assigned by the main shelf', default=None, alias="shelf-ip-address")
...
class OtsItem(YangBaseModel):
    ...
    avail_status: str | None = Field(json_schema_extra={'is_config': False}, description="Provided to qualify the operational, usage and/or administrative status attributes.\nThe value shall be a bits, management interface shall show the string with space separator ' ' per yang definition.\n\nFollowing available status indication shall be supported:\nFailed,Mismatch,LowerLayerDown,NotPresent,Shutdown,Degraded,Idle,Busy,\nHibernation,In-Test,Loopback,SoftwareUpgrade,Initializing,Unknown,Incomplete\n\nExample: an ODU can be failed without cross connection, the available status is 'Failed Idle'.\n\nProvided to qualify the operational, usage and/or administrative state attributes. The value of each\nstatus attribute may denote the presence of one or more particular conditions applicable to the resource.", default=None, alias="avail-status")
    alias_name: Annotated[str, AfterValidator(lambda v: check_pattern('^(?:[A-Za-z0-9_\\-/,\\.]*)$', v))] | None = Field(json_schema_extra={'is_config': True}, description='User defined alias for this entity. Must be an alphanumeric string with dash or underscore', min_length=0, max_length=256, default=None, alias="alias-name")
    supporting_rx_port: str | str | None = Field(json_schema_extra={'is_config': True}, description='Supporting Rx port for the optical interface.', default=None, alias="supporting-rx-port")
    supporting_tx_port: str | str | None = Field(json_schema_extra={'is_config': True}, description='Supporting Tx port for the optical interface.', default=None, alias="supporting-tx-port")
...
class OscItem(YangBaseModel):
    ...
    supporting_rx_port: str | str | None = Field(json_schema_extra={'is_config': True}, description='Supporting Rx port for the optical interface.', default=None, alias="supporting-rx-port")
    supporting_tx_port: str | str | None = Field(json_schema_extra={'is_config': True}, description='Supporting Tx port for the optical interface.', default=None, alias="supporting-tx-port")
    parent_ots_interface: str | str | None = Field(json_schema_extra={'is_config': True}, description='Supporting OTS insterface.', default='unassigned', alias="parent-ots-interface")
...
class OchItem(YangBaseModel):
    ...
    supporting_rx_port: str | str | None = Field(json_schema_extra={'is_config': True}, description='Supporting Rx port for the optical interface.', default=None, alias="supporting-rx-port")
    supporting_tx_port: str | str | None = Field(json_schema_extra={'is_config': True}, description='Supporting Tx port for the optical interface.', default=None, alias="supporting-tx-port")
    parent_entity: str | str | None = Field(json_schema_extra={'is_config': True}, description='Supporting OMS interface.', default='none', alias="parent-entity")
...
class L2Dcn(YangBaseModel):
    ...
    ip_address: str | str = Field(json_schema_extra={'is_config': True}, description='IP Address of device', alias="ip-address")
    ...
    default_gateway: str | str | None = Field(json_schema_extra={'is_config': True}, description='Default Gateway', default=None, alias="default-gateway")
    source: SourceEnum | None = Field(json_schema_extra={'is_config': False}, default=None)
    current_ip_address: str | str | None = Field(json_schema_extra={'is_config': False}, description='Current IP Address of device', default=None, alias="current-ip-address")
    ...
    current_default_gateway: str | str | None = Field(json_schema_extra={'is_config': False}, description='Current Default Gateway', default=None, alias="current-default-gateway")
...
class NextHopItem(YangBaseModel):
    ...
    next_hop_address: str | str | None = Field(json_schema_extra={'is_config': True}, description='IP address of the next-hop.', default=None, alias="next-hop-address")
...
class StaticRouteItem(YangBaseModel):
    ...
    destination_prefix: str | str = Field(json_schema_extra={'is_config': True}, description='IP destination prefix.', alias="destination-prefix")
...
class BgpNeighborTransport(YangBaseModel):
    ...
    remote_address: str | str | None = Field(json_schema_extra={'is_config': False}, description='Remote address to which the BGP session has been\nestablished', default=None, alias="remote-address")
...
uniquely identified by peer IPv[46] address"""
    ...
    neighbor_address: str | str = Field(json_schema_extra={'is_config': True}, description='Address of the BGP peer, either in IPv4 or IPv6', alias="neighbor-address")
...
class NextHop(YangBaseModel):
    ...
    next_hop_address: str | str | None = Field(json_schema_extra={'is_config': False}, description='IPv4 address of the next-hop.', default=None, alias="next-hop-address")
    source_address: str | str | None = Field(json_schema_extra={'is_config': False}, description='source address of packet out chosen by kernel if the source address has not been chosen by applcation.', default=None, alias="source-address")
...
class NeighborItem(YangBaseModel):
    ...
    ip: str | str = Field(json_schema_extra={'is_config': True}, description='The IP address of the neighbor node.')
...
matched against entries in the SPD."""
    ...
    local_subnet: str | str = Field(json_schema_extra={'is_config': True}, description='Local IP address subnet.', alias="local-subnet")
    remote_subnet: str | str = Field(json_schema_extra={'is_config': True}, description='Remote IP address subnet.', alias="remote-subnet")
...
established with these nodes."""
    ...
    local_address: str | str = Field(json_schema_extra={'is_config': True}, description='local address.', alias="local-address")
    ...
    remote_address: str | str = Field(json_schema_extra={'is_config': True}, description='remote address.', alias="remote-address")
...
class AaaServerItem(YangBaseModel):
    ...
    server_ip: str | str = Field(json_schema_extra={'is_config': True}, description='The IP address of AAA server.', alias="server-ip")
...
class KeySyncSessionItem(YangBaseModel):
    ...
    local_certificate: str | str | None = Field(json_schema_extra={'is_config': True}, description='Previously installed certificate that authenticates the NE.', default='none', alias="local-certificate")
    ...
    source_address_from: str | str | None = Field(json_schema_extra={'is_config': True}, description="specifies the interface of the source IP address of the outgoing packets.\n\nCondition (when): ../key-sync-session-type = 'manual'", default='auto', alias="source-address-from")
...
class Security(YangBaseModel):
    ...
    grpc_local_certificate: str | str | None = Field(json_schema_extra={'is_config': True}, description='Certificate for gRPC dial-in server and dial-out client.', default='none', alias="grpc-local-certificate")
    grpc_dial_out_trusted_certgrp: str | str | None = Field(json_schema_extra={'is_config': True}, description='trusted certificate group for gRPC dial-out client.', default='none', alias="grpc-dial-out-trusted-certgrp")
    grpc_dial_in_trusted_certgrp: str | str | None = Field(json_schema_extra={'is_config': True}, description='trusted certificate group for gRPC dial-in server.', default='none', alias="grpc-dial-in-trusted-certgrp")
    ...
    https_local_certificate: str | str | None = Field(json_schema_extra={'is_config': True}, description='Certificate for both WebGUI https server and RESTCONF https server.', default='none', alias="https-local-certificate")
    restconf_https_trusted_certgrp: str | str | None = Field(json_schema_extra={'is_config': True}, description='Certificate group for RESTCONF https server.', default='none', alias="restconf-https-trusted-certgrp")
...
class LogServerItem(YangBaseModel):
    ...
    log_server_ip_address: str | str = Field(json_schema_extra={'is_config': True}, description='The leaf uniquely specifies the ipv4 address of the remote host.', alias="log-server-ip-address")
...
to exclude items are also provided."""
    ...
    model_path: str | str = Field(json_schema_extra={'is_config': True}, description='Path to a section of operational state of interest\n(the sensor).', alias="model-path")
...
class DestinationItem(YangBaseModel):
    ...
    destination_address: str | str = Field(json_schema_extra={'is_config': True}, description='IP address of the telemetry stream destination', alias="destination-address")
...
state information in the model (sensor data)"""
    ...
    local_source_address: str | str | str | None = Field(json_schema_extra={'is_config': True}, description='The IP address which will be the source of packets from\nthe device to a telemetry collector destination.', default='auto', alias="local-source-address")
...
subscriptions."""
    ...
    subscription_id: Uint64 | None = Field(json_schema_extra={'is_config': False}, description='System generated identifer of the telemetry\nsubscription.', ge=0, le=18446744073709551615, default=None, alias="subscription-id")
    destination_address: str | str | None = Field(json_schema_extra={'is_config': False}, description='IP address of the telemetry stream destination', default=None, alias="destination-address")
...
paths of interest"""
    ...
    model_path: str | str = Field(json_schema_extra={'is_config': False}, description='Path to a section of operational state of interest\n(the sensor).', alias="model-path")
...
class NtpAssociationItem(YangBaseModel):
    ...
    ntp_association_source: str | str = Field(json_schema_extra={'is_config': True}, description='Indicates the ntp-association-source.', alias="ntp-association-source")
...
class Ntp(YangBaseModel):
    ...
    current_time_source: str | str | None = Field(json_schema_extra={'is_config': False}, description='Indicates the current time source.', default='0.0.0.0', alias="current-time-source")
...
class SnmpTargetItem(YangBaseModel):
    ...
    target_ip: str | str = Field(json_schema_extra={'is_config': True}, description='IP address of the SNMP target', alias="target-ip")
...
class MultishelfDiscoveryItem(YangBaseModel):
    ...
    shelf_linklocal_ip_address: str | str | None = Field(json_schema_extra={'is_config': False}, description='The link local IP address of the shelf, which is used during the shelf topology establishment phase', default=None, alias="shelf-linklocal-ip-address")
