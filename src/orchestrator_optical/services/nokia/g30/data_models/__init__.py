...
class Operations(BaseModel):
    ...
    start_otdr_measurement: coriant_rpc.StartOtdrMeasurement | None = Field(None, alias="coriant-rpc:start-otdr-measurement")
    stop_otdr_measurement: coriant_rpc.StopOtdrMeasurement | None = Field(None, alias="coriant-rpc:stop-otdr-measurement")
    ...
    clear_statistics_data: coriant_rpc.ClearStatisticsData | None = Field(None, alias="coriant-rpc:clear-statistics-data")
    clear_certificate: coriant_rpc.ClearCertificate | None = Field(None, alias="coriant-rpc:clear-certificate")
    clear_trusted_certificate: coriant_rpc.ClearTrustedCertificate | None = Field(None, alias="coriant-rpc:clear-trusted-certificate")
    ...
    reset_test_signal_status: coriant_rpc.ResetTestSignalStatus | None = Field(None, alias="coriant-rpc:reset-test-signal-status")
    ...
    create_rollback_point: coriant_rpc.CreateRollbackPoint | None = Field(None, alias="coriant-rpc:create-rollback-point")
