...
class DefaultNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.DefaultInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.DefaultOutput:
...
class DownloadNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.DownloadInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.DownloadOutput:
...
class FileNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.FileInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.FileOutput:
...
class CertGenNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.CertGenInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.CertGenOutput:
...
class RestartNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.RestartInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.RestartOutput:
...
class UploadNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.UploadInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.UploadOutput:
...
class SetTimeNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.SetTimeInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.SetTimeOutput:
...
class EnableLedNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.EnableLedInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.EnableLedOutput:
...
class DisableLedNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.DisableLedInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.DisableLedOutput:
...
class StartOtdrMeasurementNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.StartOtdrMeasurementInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.StartOtdrMeasurementOutput:
...
class StopOtdrMeasurementNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.StopOtdrMeasurementInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.StopOtdrMeasurementOutput:
...
class Activate3rdpartyFwNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.Activate3rdpartyFwInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.Activate3rdpartyFwOutput:
...
class ActivateFileNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.ActivateFileInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.ActivateFileOutput:
...
class ClearLogNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.ClearLogInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.ClearLogOutput:
...
class ClearDatabaseNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.ClearDatabaseInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.ClearDatabaseOutput:
...
class PingNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.PingInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.PingOutput:
...
class TracerouteNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.TracerouteInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.TracerouteOutput:
...
class UpdatePskMapNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.UpdatePskMapInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.UpdatePskMapOutput:
...
class FilterItemNode(ItemNode):
    ...
    def retrieve(self, *, content: str = "all", with_defaults: str = "report-all", depth: int | str = 2, fields: list[str] | None = None) -> coriant_rpc.FilterItem:
...
class FilterListNode(ListNode[FilterItemNode]):
    ...
    def retrieve(self, *, content: str = "all", with_defaults: str = "report-all", depth: int | str = 2, fields: list[str] | None = None) -> list[coriant_rpc.FilterItem]:
        from ..data_models.coriant_rpc import FilterItem
        resp = self._retrieve(content=content, with_defaults=with_defaults, depth=depth, fields=fields)
...
class PmDataItemNode(ItemNode):
    ...
    def retrieve(self, *, content: str = "all", with_defaults: str = "report-all", depth: int | str = 2, fields: list[str] | None = None) -> coriant_rpc.PmDataItem:
...
class PmDataListNode(ListNode[PmDataItemNode]):
    ...
    def retrieve(self, *, content: str = "all", with_defaults: str = "report-all", depth: int | str = 2, fields: list[str] | None = None) -> list[coriant_rpc.PmDataItem]:
        from ..data_models.coriant_rpc import PmDataItem
        resp = self._retrieve(content=content, with_defaults=with_defaults, depth=depth, fields=fields)
...
class GetPmNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.GetPmInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.GetPmOutput:
...
class PmEntityListItemNode(ItemNode):
    ...
    def retrieve(self, *, content: str = "all", with_defaults: str = "report-all", depth: int | str = 2, fields: list[str] | None = None) -> coriant_rpc.PmEntityListItem:
...
class PmEntityListListNode(ListNode[PmEntityListItemNode]):
    ...
    def retrieve(self, *, content: str = "all", with_defaults: str = "report-all", depth: int | str = 2, fields: list[str] | None = None) -> list[coriant_rpc.PmEntityListItem]:
        from ..data_models.coriant_rpc import PmEntityListItem
        resp = self._retrieve(content=content, with_defaults=with_defaults, depth=depth, fields=fields)
...
class ClearPmDataNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.ClearPmDataInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.ClearPmDataOutput:
...
class ClearStatisticsDataNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.ClearStatisticsDataInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.ClearStatisticsDataOutput:
...
class ClearCertificateNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.ClearCertificateInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.ClearCertificateOutput:
...
class ClearTrustedCertificateNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.ClearTrustedCertificateInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.ClearTrustedCertificateOutput:
        from ..data_models.coriant_rpc import (
...
class SshKeygenNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.SshKeygenInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.SshKeygenOutput:
...
class PasswordNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.PasswordInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.PasswordOutput:
...
class ResetTestSignalStatusNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.ResetTestSignalStatusInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.ResetTestSignalStatusOutput:
        from ..data_models.coriant_rpc import (
...
class CreateCardServicesNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.CreateCardServicesInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.CreateCardServicesOutput:
...
class DeleteCardServicesNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.DeleteCardServicesInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.DeleteCardServicesOutput:
...
class IfconfigNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.IfconfigInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.IfconfigOutput:
...
class CreateRollbackPointNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.CreateRollbackPointInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.CreateRollbackPointOutput:
...
class DiffNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.DiffInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.DiffOutput:
...
class RollbackNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.RollbackInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.RollbackOutput:
...
class ProtectionSwitchNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.ProtectionSwitchInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.ProtectionSwitchOutput:
...
class CliCommandNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.CliCommandInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.CliCommandOutput:
...
class MeasureNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.MeasureInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.MeasureOutput:
...
class DbBackupNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.DbBackupInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.DbBackupOutput:
...
class RepairInfoNode(Node):
    ...
    def __call__(self, input_data: coriant_rpc.RepairInfoInput | dict | str | None = None, **kwargs: Any) -> coriant_rpc.RepairInfoOutput:
