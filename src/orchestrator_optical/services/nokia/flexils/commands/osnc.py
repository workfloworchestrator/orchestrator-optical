...
from orchestrator_optical.services.nokia.flexils.commands.base import TL1BaseCommand, TL1BaseResponse
...
class EnterOsnc(TL1BaseCommand):
    ...
    modulation: Literal["PM-QPSK", "PM-BPSK", "PM-EBPSK", "PM-3QAM", "PM-8QAM", "PM-16QAM", "PM-NONE"] | None = (
        "PM-NONE"
    )
    ...
    restorationtrigger: Literal["OPTICALSF", "DIGITALSF", "DIGITALSFNSD"] | None = "OPTICALSF"
    is_oos: str | None = "IS"
...
class EditOsnc(TL1BaseCommand):
    ...
    restorationtrigger: Literal["OPTICALSF", "DIGITALSF", "DIGITALSFNSD"] | None = None
