...
class RetrieveScg(TL1BaseCommand):
    ...
    type: (
        Literal["FMM", "FRM", "FSM", "OFX", "FMP", "FMMF250", "FMMC5", "XT", "FMMC12", "FBM", "MXP", "FMMC6", "FMMC6L"]
        | None
    ) = None
...
class EditScg(TL1BaseCommand):
    ...
    intftyp: (
        Literal["INFWAVE", "OPENWAVE", "ASEIDLER", "MANUALMODE-1", "MANUALMODE-2", "SLTEMANUAL-1", "PASSIVE"] | None
    ) = None
    ...
    defflexlicmodformat: Literal["BPSK", "QPSK", "3QAM", "8QAM", "16QAM"] | None = None
