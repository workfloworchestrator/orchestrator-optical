...
class RealTimePmItem(YangBaseModel):
    ...
    pm_value: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': False}, description='PM parameter value. Provided for real-time PM and counters.', default=None, alias="pm-value")
    pm_value_min: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': False}, description='PM parameter minimum value. Provided for gauges.', default=None, alias="pm-value-min")
    pm_value_max: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': False}, description='PM parameter maximum value. Provided for gauges.', default=None, alias="pm-value-max")
    pm_value_avg: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': False}, description='PM parameter average value. Provided for gauges.', default=None, alias="pm-value-avg")
...
instead."""
    ...
    low_threshold: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': True}, description='Configured low threshold value for this parameter for this individual resource.', default=None, alias="low-threshold")
    high_threshold: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': True}, description='Configured high threshold value for this parameter for this individual resource.', default=None, alias="high-threshold")
...
class PmThresholdProfileItem(YangBaseModel):
    ...
    parameter: str = Field(json_schema_extra={'is_config': True}, description='PM parameter identifier (can be a counter or a gauge).')
    low_threshold: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': True}, description='Configured low threshold value for resources that have this parameter.', default=None, alias="low-threshold")
    high_threshold: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': True}, description='Configured high threshold value for resources that have this parameter.', default=None, alias="high-threshold")
    default_low_threshold: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': False}, description='System defined default value for low threshold for this parameter.', default=None, alias="default-low-threshold")
    default_high_threshold: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': False}, description='System defined default value for high threshold for this parameter.', default=None, alias="default-high-threshold")
    min_value: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': False}, description='Minimum value for this parameter.', default=None, alias="min-value")
    max_value: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': False}, description='Maximum value for this parameter.', default=None, alias="max-value")
...
The bin key is only used for history; current and real-time always use 0."""
    ...
    pm_value: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': None}, description='PM parameter value. Provided for real-time PM and counters.', default=None, alias="pm-value")
    pm_value_min: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': None}, description='PM parameter minimum value. Provided for gauges.', default=None, alias="pm-value-min")
    pm_value_max: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': None}, description='PM parameter maximum value. Provided for gauges.', default=None, alias="pm-value-max")
    pm_value_avg: int | int | float | float | float | float | float | str | None = Field(json_schema_extra={'is_config': None}, description='PM parameter average value. Provided for gauges.', default=None, alias="pm-value-avg")
...
class GetPmInput(YangBaseModel):
    ...
    chassis_scope: str | str | None = Field(json_schema_extra={'is_config': None}, description='Chassis scope of command.', default='all', alias="chassis-scope")
