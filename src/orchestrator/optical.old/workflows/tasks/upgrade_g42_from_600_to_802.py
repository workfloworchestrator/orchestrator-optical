...
!!! warning "Requirements"
    ...
    | Item | Path / Filename |
    | :--- | :--- |
    | **Images Base Path** | `/nokia/tnms/nedata/ne_software_images/G42_$version/` |
    | **R6.0.1 Image** | `unzipped, includes G40_ADV-R6.0.1-F-2022.11.28_11_41-45.manifest` |
    | **R7.1.1 Image** | `unzipped, includes G40_ADV-R7.1.1-F-2024.11.29_11_11-52.manifest` |
    | **R8.0.2 Image** | `unzipped, includes G40_ADV-R8.0.2-F-2025.11.13_10_43-140.manifest` |
...
_sftp_user = os.environ["TNMS_SFTP_USER"]
SFTP_PASS = os.environ["TNMS_SFTP_PSW"]
UPLOAD_PATH = f"sftp://{_sftp_user}@{_sftp_server}:/nokia/tnms/nedata/ne_backup_before_upgrade/"
DOWNLOAD_TEMPLATE = Template(
    f"sftp://{_sftp_user}@{_sftp_server}:/nokia/tnms/nedata/ne_software_images/G42_$version/$manifest_filename"
)
MAPPING = {
