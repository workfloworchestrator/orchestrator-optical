...
def configure_fiber_terminations(
    ...
    check_fiber_terminating_port(port_a.optical_device, port_a, port_b)
    check_fiber_terminating_port(port_b.optical_device, port_b, port_a)
...
def validate_optical_fiber() -> StepList:
    return begin >> load_initial_state_optical_fiber >> update_subscription_description >> retrieve_used_passbands
