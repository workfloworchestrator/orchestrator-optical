...
def factory_reset_ports(subscription: OpticalFiber) -> State:
    ...
    results[port_a.optical_device.fqdn] = factory_reset_port_configuration(port_a.optical_device, port_a, port_b)
    results[port_b.optical_device.fqdn] = factory_reset_port_configuration(port_b.optical_device, port_b, port_a)
    return results
