...
def optical_port_selector(optical_device_subscription_id: UUIDstr, prompt: str = "") -> type[Choice]:
...
def unused_optical_port_selector(optical_device_subscription_id: UUIDstr, prompt: str = "") -> type[Choice]:
    ...
    ports_siv_list: list[SubscriptionInstanceValueTable] = (
        subscription_instance_values_by_block_type_depending_on_instance_id(
            ...
            depending_on_instance_id=str(subscription.optical_device.subscription_instance_id),
...
def optical_client_port_selector(optical_device_subscription_id: UUIDstr, prompt: str = "") -> type[Choice]:
    """Return a Choice object for selecting an optical port of an OpticalDevice."""
    subscription = OpticalDevice.from_subscription(optical_device_subscription_id)
...
def unused_optical_client_port_selector(optical_device_subscription_id: UUIDstr, prompt: str = "") -> type[Choice]:
    """Return a Choice object for selecting an unused optical port of an OpticalDevice."""
    subscription = OpticalDevice.from_subscription(optical_device_subscription_id)
    ports = get_device_client_ports_names(subscription.optical_device)
...
def optical_line_port_selector(optical_device_subscription_id: UUIDstr, prompt: str = "") -> type[Choice]:
    """Return a Choice object for selecting an optical port of an OpticalDevice."""
    subscription = OpticalDevice.from_subscription(optical_device_subscription_id)
...
def unused_optical_line_port_selector(optical_device_subscription_id: UUIDstr, prompt: str = "") -> type[Choice]:
    """Return a Choice object for selecting an unused optical port of an OpticalDevice."""
    subscription = OpticalDevice.from_subscription(optical_device_subscription_id)
    ports = get_device_line_ports_names(subscription.optical_device)
...
def multiple_optical_device_selector(
    ...
    *,
    ...
    """
    base_choice: type[Choice] = optical_device_selector_of_types(device_types, prompt)
