...
def modify_leased_spectrum_form_pages(
    ...
    steps of :data:`MODIFY_LEASED_SPECTRUM_BLOCK_STEPS`. Consumers yield from
...
def modify_leased_spectrum_form_generator(
    ...
    user_input_dict = yield from modify_leased_spectrum_form_pages(subscription, block_field_name)
