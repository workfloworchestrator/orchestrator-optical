...
def terminate_optical_node_nokia_flexils_workflow(
    *,
    ...
    **kwargs: Any,
    ...
    """Build the terminate_optical_node_nokia_flexils workflow, optionally extended with user hooks.
    ...
    return terminate_optical_node_nokia_flexils
