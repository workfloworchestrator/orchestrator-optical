...
def construct_optical_node_nokia_flexils_subscription(
    ...
    ``OPTICAL_MODULE_BLOCK_STATE_KEY``.
    """
    subscription = OpticalNodeNokiaFlexIlsSubscriptionInactive.from_product_id(
        product_id=product,
    ...
    subscription = OpticalNodeNokiaFlexIlsSubscriptionProvisioning.from_other_lifecycle(
