...
def construct_optical_node_nokia_groove_g30_subscription(
    ...
    ``OPTICAL_MODULE_BLOCK_STATE_KEY``.
    """
    subscription = OpticalNodeNokiaGrooveG30SubscriptionInactive.from_product_id(
        product_id=product,
    ...
    subscription = OpticalNodeNokiaGrooveG30SubscriptionProvisioning.from_other_lifecycle(
