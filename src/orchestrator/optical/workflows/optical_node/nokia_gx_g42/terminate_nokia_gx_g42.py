...
This module ships the ready-to-use ``terminate_optical_node_nokia_gx_g42``
workflow for the shipped Nokia GX G42 product type. The termination steps are
...
def terminate_optical_node_nokia_gx_g42() -> StepList:
    """Workflow to terminate a Nokia GX G42 Optical Node subscription."""
    return begin >> OPTICAL_NODE_TERMINATE_STEPS


__all__ = ["terminate_optical_node_nokia_gx_g42"]
