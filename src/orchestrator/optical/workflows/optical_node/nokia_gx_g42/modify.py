...
def modify_optical_node_nokia_gx_g42_form_pages(
    ...
    steps of :data:`MODIFY_NOKIA_GX_G42_BLOCK_STEPS`. Consumers yield from it
...
def modify_optical_node_nokia_gx_g42_form_generator(
    ...
    user_input_dict = yield from modify_optical_node_nokia_gx_g42_form_pages(subscription, block_field_name)
