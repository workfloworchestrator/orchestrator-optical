...
def create_optical_node_nokia_gx_g42_workflow(
    *,
    ...
    **kwargs: Any,
    ...
    """Build the create_optical_node_nokia_gx_g42 workflow, optionally extended with user hooks.
    ...
    def create_optical_node_nokia_gx_g42() -> StepList:
        ...
        return (
            pre_steps
            >> begin
            >> construct_optical_node_nokia_gx_g42_model
            >> store_process_subscription()
            >> post_steps
        )

    return create_optical_node_nokia_gx_g42
