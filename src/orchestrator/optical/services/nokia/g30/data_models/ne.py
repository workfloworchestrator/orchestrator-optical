...
from orchestrator.optical.services.nokia.g30.data_models._base import YangBaseModel
...
class TemperatureDetailsItem(YangBaseModel):
    ...
    monitoring_point: str = Field(
        ...
        alias="monitoring-point",
    )
    temperature: Decimal64 | None = Field(
        json_schema_extra={"is_config": False}, description="Temperature at the monitoring point.", default=None
    )
    temperature_range_low: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The lowest temperature threshold of this monitoring point in working mode.",
        default=None,
        alias="temperature-range-low",
    )
    temperature_range_high: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The highest temperature threshold of this monitoring point in working mode.",
        default=None,
        alias="temperature-range-high",
    )
...
class PerCoreUtilizationItem(YangBaseModel):
    ...
    core_index: int = Field(
        json_schema_extra={"is_config": False}, description="The index of the CPU core", ge=0, alias="core-index"
    )
    utilization: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
...
class CpuState(YangBaseModel):
    ...
    cpu_total_utilization: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
    ...
    per_core_utilization: RestconfList[PerCoreUtilizationItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="Each CPU core's utilization",
        default=None,
        alias="per-core-utilization",
    )
...
class Otdr(YangBaseModel):
    ...
    otdr_laser_status: OtdrLaserStatusEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicating the current status of the OTDR laser.",
        default=OtdrLaserStatusEnum.NOT_AVAILABLE,
        alias="otdr-laser-status",
    )
    otdr_measurement_port: int | None = Field(
        json_schema_extra={"is_config": False},
    ...
    otdr_file_name: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicating the file name of the current OTDR test result.",
        min_length=0,
        max_length=256,
        default=None,
    )
    otdr_file_prefix: (
        ...
        json_schema_extra={"is_config": True},
        description="Indicating the file name prefix of the current OTDR test result.",
        min_length=0,
        max_length=64,
        default=None,
...
class OpticalPowerLaneItem(YangBaseModel):
    ...
    rx_optical_power: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Received optical power",
        default=None,
        alias="rx-optical-power",
    )
    tx_optical_power: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Transmitted optical power",
        default=None,
        alias="tx-optical-power",
    )
...
class TestSignalFacilityStatus(YangBaseModel):
    ...
    prbs_sync: PrbsSyncEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="The test result of PRBS Synchronization",
        default=PrbsSyncEnum.NOT_APPLICABLE,
        alias="prbs-sync",
    )
    test_time_duration: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The time duration of signal test",
        ge=0,
        default=None,
        alias="test-time-duration",
    )
    prbs_bit_error_count: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The counting of bit error by PRBS Synchronization",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="prbs-bit-error-count",
    )
...
class RemoteManAddressesItem(YangBaseModel):
    ...
    remote_man_addr_if_subtype: int | None = Field(
        ...
        ge=0,
        default=None,
        alias="remote-man-addr-if-subtype",
    )
    remote_man_addr_if_id: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The integer value used to identify the interface number\nregarding the management address component associated with\nthe remote system.\nman: management\naddr: address",
        ge=0,
        default=None,
        alias="remote-man-addr-if-id",
    )
    remote_man_addr_oid: str | None = Field(
        json_schema_extra={"is_config": False},
        description="The OID value used to identify the type of hardware component\nor protocol entity associated with the management address\nadvertised by the remote system agent.\nman: management\naddr: address\noid: object identifier",
        min_length=0,
        max_length=128,
        default=None,
        alias="remote-man-addr-oid",
    )
    or_remote_man_addr_subtype: AddressFamilyEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="remote neighbour Management Address Subtype Enumeration",
        default=None,
        alias="or-remote-man-addr-subtype",
    )
...
class LldpRemoteSystemItem(YangBaseModel):
    ...
    lldp_remote_index: int = Field(
        json_schema_extra={"is_config": True},
        description="This attribute represents an arbitrary local integer value used\nby this agent to identify a particular connection instance,\nunique only for the indicated remote system.",
        ge=0,
        alias="lldp-remote-index",
    )
    remote_chassis_id_subtype: RemoteChassisIdSubtypeEnum | None = Field(
        json_schema_extra={"is_config": False},
    ...
    remote_sys_cap_supported: str | None = Field(
        ...
        default=None,
        alias="remote-sys-cap-supported",
    )
    remote_sys_cap_enabled: str | None = Field(
        json_schema_extra={"is_config": False},
        description="This attribute describes the system capabilities.\nThe bit 'other(0)' indicates that the system has capabilities\nother than those listed below.\nThe bit 'repeater(1)' indicates that the system has repeater\ncapability.\nThe bit 'bridge(2)' indicates that the system has bridge\ncapability.\nThe bit 'wlanAccessPoint(3)' indicates that the system has\nWLAN access point capability.\nThe bit 'router(4)' indicates that the system has router\ncapability.\nThe bit 'telephone(5)' indicates that the system has telephone\ncapability.\nThe bit 'docsisCableDevice(6)' indicates that the system has\nDOCSIS Cable Device capability (IETF RFC 2669 & 2670).\nThe bit 'stationOnly(7)' indicates that the system has only\nstation capability and nothing else.\nThe bit 'cVLANComponent(8)' indicates that the system has\nC-VLAN component functionality.\nThe bit 'sVLANComponent(9)' indicates that the system  has\nS-VLAN component functionality.\nThe bit 'twoPortMACRelay(10)' indicates that the system has\nTwo-port MAC Relay (TPMR) functionality.",
        default=None,
        alias="remote-sys-cap-enabled",
    )
    ...
    management_address_type: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The last reported remote management address type",
        ge=0,
        default=None,
        alias="management-address-type",
    )
    remote_man_addresses: RestconfList[RemoteManAddressesItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="List of management addresses of LLDP neighbor.\nman:managment, remote management addresses",
        default=None,
        alias="remote-man-addresses",
    )
...
class BitErrorRatePreFec(YangBaseModel):
    ...
    instant: Decimal64 | None = Field(
        json_schema_extra={"is_config": False}, description="the instant value of statistics counter", default=None
    )
    avg: Decimal64 | None = Field(
        json_schema_extra={"is_config": False}, description="the average value of statistics counter", default=None
    )
    min: Decimal64 | None = Field(
        json_schema_extra={"is_config": False}, description="the minimum value of statistics counter", default=None
    )
    max: Decimal64 | None = Field(
        json_schema_extra={"is_config": False}, description="the maximum value of statistics counter", default=None
    )
...
class Statistics(YangBaseModel):
    ...
    in_packets_512to1023octets: Uint64 | None = Field(
        ...
        le=18446744073709551615,
        default=None,
        alias="in-packets-512to1023octets",
    )
    in_packets_1024to1518octets: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
    ...
    out_packets_128to255octets: Uint64 | None = Field(
        ...
        le=18446744073709551615,
        default=None,
        alias="out-packets-128to255octets",
    )
    out_packets_256to511octets: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        ...
        le=18446744073709551615,
        default=None,
        alias="out-packets-256to511octets",
    )
    out_packets_512to1023octets: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        ...
        le=18446744073709551615,
        default=None,
        alias="out-packets-512to1023octets",
    )
    out_packets_1024to1518octets: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        ...
        le=18446744073709551615,
        default=None,
        alias="out-packets-1024to1518octets",
    )
    bit_error_rate_pre_fec: BitErrorRatePreFec | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="bit-error-rate-pre-fec",
    )
    bit_error_rate_post_fec: BitErrorRatePostFec | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="bit-error-rate-post-fec",
    )
    in_utilization: InUtilization | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="in-utilization",
    )
    out_utilization: OutUtilization | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="out-utilization",
    )
    in_coding_violation: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics bits counting for ingress coding violation, corresponding to pm parameter CV\n\nCondition (when): ../../port-type = 'osc'",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="in-coding-violation",
    )
    errored_seconds: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
    ...
    severely_errored_seconds: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
    ...
    unavailable_seconds: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics seconds counting for unavailable signal, corresponding to pm parameter UAS\n\nCondition (when): ../../port-type = 'osc'",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="unavailable-seconds",
    )
    in_background_block_error: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for ingress errored blocks, corresponding to pm parameter BBE\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="in-background-block-error",
    )
    out_background_block_error: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for egress errored blocks, corresponding to pm parameter BBE\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="out-background-block-error",
    )
    in_background_block_error_rate: InBackgroundBlockErrorRate | None = Field(
        json_schema_extra={"is_config": False},
        description="statistics value: average, minimum, maximum and instant value corresponding to ingress pm parameter BBER\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        default=None,
        alias="in-background-block-error-rate",
    )
    out_background_block_error_rate: OutBackgroundBlockErrorRate | None = Field(
        json_schema_extra={"is_config": False},
        description="statistics value: average, minimum, maximum and instant value corresponding to egress pm parameter BBER\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        default=None,
        alias="out-background-block-error-rate",
    )
    in_severely_errored_seconds_rate: InSeverelyErroredSecondsRate | None = Field(
        json_schema_extra={"is_config": False},
        description="statistics value: average, minimum, maximum and instant value corresponding to ingress pm parameter SESR\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        default=None,
        alias="in-severely-errored-seconds-rate",
    )
    out_severely_errored_seconds_rate: OutSeverelyErroredSecondsRate | None = Field(
        json_schema_extra={"is_config": False},
        description="statistics value: average, minimum, maximum and instant value corresponding to egress pm parameter SESR\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        default=None,
        alias="out-severely-errored-seconds-rate",
    )
    in_errored_blocks: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for errored blocks, corresponding to pm parameter EB ingress\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="in-errored-blocks",
    )
    out_errored_blocks: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for errored blocks, corresponding to pm parameter EB egress\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="out-errored-blocks",
    )
    in_bip_errored_blocks: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for ingress BIP errored blocks, corresponding to pm parameter BE\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="in-bip-errored-blocks",
    )
    out_bip_errored_blocks: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for egress BIP errored blocks, corresponding to pm parameter BE\n\nCondition (when): ../../port-mode = ('1GBE', '10GBE', '40GBE', '100GBE')",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="out-bip-errored-blocks",
    )
...
class OduEncryption(YangBaseModel):
    ...
    encryption_enable: EncryptionEnableEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Setting AES-256 encryption on OTN",
        default=EncryptionEnableEnum.DISABLED,
        alias="encryption-enable",
    )
    block_cipher_mode: BlockCipherModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Specifies the block cipher mode of operation.",
        default=None,
        alias="block-cipher-mode",
    )
    encryption_interval: int | None = Field(
        json_schema_extra={"is_config": True},
        description="The encryption key rotation interval (in minutes)",
        ge=10,
        le=1440,
        default=30,
        alias="encryption-interval",
    )
    time_to_next_key: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The time left to rotate the ODU encryption key.",
        ge=0,
        default=0,
        alias="time-to-next-key",
    )
    encryption_tx_status: str | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="encryption-tx-status",
    )
    encryption_rx_status: str | None = Field(
        json_schema_extra={"is_config": False},
        description="The encryption status at receive side of the ODU,\nwhich reflects the status of both encryption data and communication sessions.",
        default=None,
        alias="encryption-rx-status",
    )
    odu_key_sync_session: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicate the associated session for the ODU channel to synchronize keys.",
        default="none",
        alias="odu-key-sync-session",
    )
    encryption_tx_channel_id: (
        Annotated[
            str,
            AfterValidator(
                lambda v: check_pattern(
                    "^(?:(([A-Za-z0-9_\\-][A-Za-z0-9_\\-\\+]*)|(\\+loc:([A-Za-z0-9]{1,})\\+rmt:([A-Za-z0-9]{1,})))?)$",
                    v,
                )
            ),
        ]
        ...
        max_length=32,
        default=None,
        alias="encryption-tx-channel-id",
    )
    encryption_termination_direction: EncryptionTerminationDirectionEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the encryption termination direction.",
        default=EncryptionTerminationDirectionEnum.PHYSICAL_PORT,
        alias="encryption-termination-direction",
    )
...
class Statistics(YangBaseModel):
    ...
    errored_blocks: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for errored blocks, corresponding to pm parameter EB",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="errored-blocks",
    )
    farend_errored_blocks: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for farend error blocks, corresponding to pm parameter FEB",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="farend-errored-blocks",
    )
    errored_seconds: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics seconds counting for errored signal, corresponding to pm parameter ES",
...
class OduItem(YangBaseModel):
    ...
    odutype_L1: OduTypeEnum = Field(
        json_schema_extra={"is_config": True}, description="Level 1 ODU type", alias="odutype-L1"
    )
    oduid_L1: int = Field(
        json_schema_extra={"is_config": True}, description="Identifier of level 1 ODU", ge=0, alias="oduid-L1"
    )
    odutype_L2: OduTypeEnum = Field(
        json_schema_extra={"is_config": True}, description="Level 2 ODU type", alias="odutype-L2"
    )
    oduid_L2: int = Field(
        json_schema_extra={"is_config": True}, description="Identifier of level 2 ODU", ge=0, alias="oduid-L2"
    )
    odutype_L3: OduTypeEnum = Field(
        json_schema_extra={"is_config": True}, description="Level 3 ODU type", alias="odutype-L3"
    )
    oduid_L3: int = Field(
        json_schema_extra={"is_config": True}, description="Identifier of level 3 ODU", ge=0, alias="oduid-L3"
    )
    odutype_L4: OduTypeEnum = Field(
        json_schema_extra={"is_config": True}, description="Level 4 ODU type", alias="odutype-L4"
    )
    oduid_L4: int = Field(
        json_schema_extra={"is_config": True}, description="Identifier of level 4 ODU", ge=0, alias="oduid-L4"
    )
    odu_type: OduTypeEnum | None = Field(
        json_schema_extra={"is_config": False}, description="Describes the type of odu", default=None, alias="odu-type"
    )
    admin_status: AdminStatusEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The administrative state specifies the permission to use or prohibition\nagainst using the resource. The administrative state can be modified by the user, and operates independently of the operability and usage of the resource.",
        default=AdminStatusEnum.UP,
        alias="admin-status",
    )
    oper_status: OperStatusEnum | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=OperStatusEnum.UP,
        alias="oper-status",
    )
    avail_status: str | None = Field(
        json_schema_extra={"is_config": False},
    ...
    rx_payload_type: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:(0x[0-9a-fA-F]{2})?)$", v))] | None = (
        Field(
            json_schema_extra={"is_config": False},
    ...
    tx_payload_type: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:(0x[0-9a-fA-F]{2})?)$", v))] | None = (
        Field(
            json_schema_extra={"is_config": True},
    ...
    nim_enable: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    opu_config_actual: OpuConfigActualEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="The actual opu configuration type",
        default=OpuConfigActualEnum.NOT_APPLICABLE,
        alias="opu-config-actual",
    )
    ...
    odu_termination_mode: OduTerminationModeEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Termination mode for ODU. It works for trace label, nim , Delay Measurement and test signal function validation",
        default=OduTerminationModeEnum.TERMINATED,
        alias="odu-termination-mode",
    )
    odu_alarm_function: OduAlarmFunctionEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The alarm transfer rang for openconfig and openroadm model",
        default=OduAlarmFunctionEnum.TTP_CTP,
        alias="odu-alarm-function",
    )
    msim_config: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Specifies msim alarm reporting or not when msi value received not followed G.709 definition\n\nCondition (when): ../odu-type = 'ODU4'",
        default=EnableSwitchEnum.ENABLED,
        alias="msim-config",
    )
    exp_sapi: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[ -~]*)$", v))] | None = Field(
        json_schema_extra={"is_config": True},
    ...
    exp_dapi: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[ -~]*)$", v))] | None = Field(
        json_schema_extra={"is_config": True},
    ...
    exp_operator: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[ -~]*)$", v))] | None = Field(
        json_schema_extra={"is_config": True},
    ...
    tx_sapi: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[ -~]*)$", v))] | None = Field(
        json_schema_extra={"is_config": True},
    ...
    tx_dapi: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[ -~]*)$", v))] | None = Field(
        json_schema_extra={"is_config": True},
    ...
    tx_operator: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[ -~]*)$", v))] | None = Field(
        json_schema_extra={"is_config": True},
    ...
    tim_defect_mode: TimModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The tim defect selection mode",
        default=TimModeEnum.NONE,
        alias="tim-defect-mode",
    )
    tim_act: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The enable switching of inserting AIS by tim function",
        default=EnableSwitchEnum.DISABLED,
        alias="tim-act",
    )
    rx_sapi: str | None = Field(
        json_schema_extra={"is_config": False},
    ...
    odu_encryption: OduEncryption | None = Field(
        json_schema_extra={"is_config": True},
        description="Encryption function for the ODU channel.",
        default=None,
        alias="odu-encryption",
    )
    ...
    test_signal_enable: TestSignalConfigEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The enable switching of test signal function",
        default=TestSignalConfigEnum.NONE,
        alias="test-signal-enable",
    )
    statistics: Statistics | None = Field(json_schema_extra={"is_config": False}, default=None)
    test_signal_status: TestSignalStatus | None = Field(
        json_schema_extra={"is_config": False},
        description="Test signal status on ODU",
        default=None,
        alias="test-signal-status",
    )
    index: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Index of the current logical client channel to tributary mapping",
        default=None,
    )
    ...
    connected_interface: str | None = Field(
        json_schema_extra={"is_config": True}, default="none", alias="connected-interface"
    )
...
class Eth10g(YangBaseModel):
    ...
    eth_fec_type: EthFecEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The FEC working type of etyn port.",
        default=EthFecEnum.AUTO,
        alias="eth-fec-type",
    )
    eth_fec_type_state: EthFecEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="The FEC working state of etyn port.",
        default=EthFecEnum.DISABLED,
        alias="eth-fec-type-state",
    )
    transmit_interpacketgap: int | None = Field(
        json_schema_extra={"is_config": True},
        description="Specifies the minimum transmit IPG value.",
        ge=8,
        le=12,
        default=8,
        alias="transmit-interpacketgap",
    )
    gfp_payload_fcs: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Enabled: GFP payload FCS will be used, Ethernet frame FCS will be removed;\nDisabled: GFP payload FCS will not be inserted, Ethernet frame FCS will be used.",
        default=EnableSwitchEnum.DISABLED,
        alias="gfp-payload-fcs",
    )
    mapping_mode: MappingModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The mapping mode of client port packets into ODUk.",
        default=MappingModeEnum.NOT_APPLICABLE,
        alias="mapping-mode",
    )
    admin_status: AdminStatusEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    client_shutdown_holdoff_timer: int | None = Field(
        ...
        le=2000,
        default=0,
        alias="client-shutdown-holdoff-timer",
    )
    holdoff_signal: YesNoEnum | None = Field(
        json_schema_extra={"is_config": True},
        ...
        default=YesNoEnum.NO,
        alias="holdoff-signal",
    )
    near_end_als: YesNoEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The switching of near end ALS.",
        default=YesNoEnum.NO,
        alias="near-end-als",
    )
    als_degrade_mode: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The switching of defect BERSD-ODU trig ALS",
        default=EnableSwitchEnum.DISABLED,
        alias="als-degrade-mode",
    )
    loopback_enable: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The enable switching of loopback function.",
        default=EnableSwitchEnum.DISABLED,
        alias="loopback-enable",
    )
    loopback_type: LoopbackTypeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The type mode of loopback function",
        default=LoopbackTypeEnum.NONE,
        alias="loopback-type",
    )
    test_signal_type: TestSignalTypeEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    test_signal_facility_status: TestSignalFacilityStatus | None = Field(
        json_schema_extra={"is_config": False},
        description="Test signal status for current facility.",
        default=None,
        alias="test-signal-facility-status",
    )
    service_label: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Path/service name of cross-connection related facility.",
...
class Statistics(YangBaseModel):
    ...
    loss_of_signal_seconds: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics seconds counting for signal loss, corresponding to pm parameter loss\n\nCondition (when): ancestor::port/port-type = 'client'",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="loss-of-signal-seconds",
    ...
    bit_error_fec: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics bits counting for error bit forward error correction, corresponding to pm parameter BE-FEC\n\nCondition (when): (ancestor::port/port-type = 'client') and (../../port-mode != 'OTU4_TRANSPARENT')",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="bit-error-fec",
    ...
    incoming_alignment_errored_seconds: int | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for incoming alignment error seconds, corresponding to pm parameter IAE",
        ge=0,
        default=None,
        alias="incoming-alignment-errored-seconds",
    )
    backward_incoming_alignment_errored_seconds: int | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting for backward incoming alignment error seconds, corresponding to pm parameter BIAE",
        ge=0,
        default=None,
        alias="backward-incoming-alignment-errored-seconds",
    )
...
class Otu4(YangBaseModel):
    ...
    fec_type: OtukFecEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The FEC type of client OTUk.\n\nCondition (when): (ancestor::port/port-type = 'client') or (ancestor::port/port-type = 'client-subport')",
        default=OtukFecEnum.G709,
        alias="fec-type",
    )
    admin_status: AdminStatusEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    port_bandwidth: int | None = Field(
        json_schema_extra={"is_config": True},
        description="port cost bandwidth in chip side, for the capacity validation in card like chm2",
        ge=0,
        default=0,
        alias="port-bandwidth",
    )
    statistics: Statistics | None = Field(json_schema_extra={"is_config": False}, default=None)
    index: str | None = Field(
        json_schema_extra={"is_config": True},
...
class Otu2(YangBaseModel):
    ...
    loopback_enable: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The enable switching of loopback function.\n\nCondition (when): (ancestor::port/port-type = 'client-subport') or (ancestor::port/port-type = 'client')",
        default=EnableSwitchEnum.DISABLED,
        alias="loopback-enable",
    )
    loopback_type: LoopbackTypeEnum | None = Field(
...
class Oc192(YangBaseModel):
    ...
    exp_trc: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[ -~]*)$", v))] | None = Field(
        json_schema_extra={"is_config": True},
    ...
    tx_trc: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[ -~]*)$", v))] | None = Field(
        json_schema_extra={"is_config": True},
        description="The transmitter trc(trail trace identification)\n\nCondition (when): ancestor::card/switching-type = 'tdm'",
        min_length=0,
        max_length=15,
        default=None,
        alias="tx-trc",
    )
    rx_trc: str | None = Field(
        json_schema_extra={"is_config": False},
    ...
    ais_type: AisTypeEnum | None = Field(
        json_schema_extra={"is_config": True}, default=AisTypeEnum.GENERIC_AIS, alias="ais-type"
    )
    odu: RestconfList[OduItem] | None = Field(json_schema_extra={"is_config": True}, default=None)
    statistics: Statistics | None = Field(json_schema_extra={"is_config": False}, default=None)
...
class Statistics(YangBaseModel):
    ...
    in_optical_power: InOpticalPower | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="in-optical-power",
    )
    out_optical_power: OutOpticalPower | None = Field(
        json_schema_extra={"is_config": False},
...
class SubportItem(YangBaseModel):
    ...
    external_connectivity: YesNoEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates the port is connected externally or not.",
        default=YesNoEnum.NO,
        alias="external-connectivity",
    )
    arc_config: ArcConfigEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The configurable mode of the Alarm Report Control (ARC).\n\nCondition (when): (port-type = 'client') or (port-type = 'client-subport')",
        default=ArcConfigEnum.NALM_QI,
        alias="arc-config",
    )
    arc_state: ArcConfigEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="The current mode of the Alarm Report Control (ARC).\n\nCondition (when): (port-type = 'client') or (port-type = 'client-subport')",
        default=ArcConfigEnum.NALM_QI,
        alias="arc-state",
    )
    arc_sub_state: ArcSubStateEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Additional information about the Alarm Report Control (ARC) when the main state is in the NALM-QI state\n\nCondition (when): (port-type = 'client') or (port-type = 'client-subport')",
        default=ArcSubStateEnum.NALM_NR,
        alias="arc-sub-state",
    )
    arc_timer: int | None = Field(
        json_schema_extra={"is_config": True},
    ...
    arc_remaining_time: str | None = Field(
        json_schema_extra={"is_config": False},
        description="The remaining timer value (format: xxd-xxh:xxm:xxs) before the alarm is reported.\n\nCondition (when): (port-type = 'client') or (port-type = 'client-subport')",
        default="00d-00h:00m:00s",
        alias="arc-remaining-time",
    )
    eth10g: Eth10g | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the 10GBE object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    eth40g: Eth40g | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the 40GBE object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    eth100g: Eth100g | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the 100GBE object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    eth400g: Eth400g | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the 400GBE object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    otu4: Otu4 | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the otu4 object\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    otu2: Otu2 | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the otu2 object\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    otu2e: Otu2e | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the otu2e object\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    oc192: Oc192 | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the OC192 object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    oc48: Oc48 | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the OC48 object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    stm64: Stm64 | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the STM64 object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    stm16: Stm16 | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the STM16 object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    wan10g_sonet: Wan10gSonet | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the 10GWAN_SONET object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
        alias="wan10g-sonet",
    )
    wan10g_sdh: Wan10gSdh | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the 10GWAN_SDH object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
        alias="wan10g-sdh",
    )
    fc1g: Fc1g | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the FC1G object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    fc4g: Fc4g | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the FC4G object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    fc8g: Fc8g | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the FC8G object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    fc16g: Fc16g | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the FC16G object.\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm')",
        default=None,
    )
    tx_optical_power: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Transmitted optical power\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm') and (port-type != 'mgmt-eth')",
        default=None,
        alias="tx-optical-power",
    )
    rx_optical_power: Decimal64 | None = Field(
    ...
    direction_type: TypeOfDirectionEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Supported direction of the optical port.\n\nCondition (when): (port-type = 'optical') or (port-type = 'otdr') or (port-type = 'optical-nomon') or (port-type = 'ocm')",
        default=None,
        alias="direction-type",
    )
    statistics: Statistics | None = Field(
        json_schema_extra={"is_config": False},
        description="Condition (when): port-type = 'client-subport'",
        default=None,
    )
    otuc2: Otuc2 | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the otuc2 object\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm') and (port-type != 'mgmt-eth')",
        default=None,
    )
    otuc3: Otuc3 | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the otuc3 object\n\nCondition (when): (port-type != 'optical') and (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm') and (port-type != 'mgmt-eth')",
        default=None,
    )
    otuc6: Otuc6 | None = Field(
        json_schema_extra={"is_config": True},
...
class ChannelStatesItem(YangBaseModel):
    ...
    laser_bias_current: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The current applied by the system to the transmit laser to\nachieve the output power. The current is expressed in mA\nwith up to two decimal precision. Just supply the instant value",
        default=None,
        alias="laser-bias-current",
    )
...
class DiagnosticAlarmThresholdsItem(YangBaseModel):
    ...
    diagnostic_parameter: DiagnosticParameterEnum = Field(
        json_schema_extra={"is_config": False},
        description="The diagnostic parameter for pluggable\nwhich support alarm by threshold",
        alias="diagnostic-parameter",
    )
    parameter_units: ParameterUnitsEnum | None = Field(
        json_schema_extra={"is_config": False}, default=None, alias="parameter-units"
    )
    high_threshold: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The high alarm threshold of this parameter",
        default=None,
        alias="high-threshold",
    )
    low_threshold: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
...
class QsfpSignalIntegrityLaneItem(YangBaseModel):
    ...
    lane_id: int = Field(
        json_schema_extra={"is_config": False}, description="Id of pluggable lane.", ge=0, alias="lane-id"
    )
    tx_input_eq_fixed_manual_control: str | float | None = Field(
        json_schema_extra={"is_config": False},
        description="Fixed manual equalization value of Tx side input for the lane.",
        default="n/a",
        alias="tx-input-eq-fixed-manual-control",
    )
    tx_input_eq_adaptive_control: SignalValEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Adaptive equalization control of Tx side input for Tx 1-4.",
        default=None,
        alias="tx-input-eq-adaptive-control",
    )
    rx_output_eq_precursor_control: str | float | None = Field(
        json_schema_extra={"is_config": False},
        description="Rx side output pre-cursor equalization values for Rx 1-4.",
        default="n/a",
        alias="rx-output-eq-precursor-control",
    )
    rx_output_eq_postcursor_control: str | float | None = Field(
        json_schema_extra={"is_config": False},
        description="Rx side output post-cursor equalization values for Rx 1-4.",
        default="n/a",
        alias="rx-output-eq-postcursor-control",
    )
    rx_output_amplitude_control: RxOutputAmplitudeControlEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Rx side output amplitude values for Rx 1-4.",
        default=RxOutputAmplitudeControlEnum.N_A,
        alias="rx-output-amplitude-control",
    )
...
class QsfpSignalIntegrity(YangBaseModel):
    ...
    tx_input_eq_fixed_manual_control_impl: SignalValEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates implementation status of Tx side input fixed manual equalization control.",
        default=None,
        alias="tx-input-eq-fixed-manual-control-impl",
    )
    rx_output_eq_precursor_control_impl: SignalValEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates implementation status of Rx side output pre-cursor equalization control.",
        default=None,
        alias="rx-output-eq-precursor-control-impl",
    )
    rx_output_eq_postcursor_control_impl: SignalValEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates implementation status of Rx side output post-cursor equalization control.",
        default=None,
        alias="rx-output-eq-postcursor-control-impl",
    )
    rx_output_amplitude_control_impl: SignalValEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates implementation status of Rx side output amplitude control.",
        default=None,
        alias="rx-output-amplitude-control-impl",
    )
    qsfp_signal_integrity_lane: RestconfList[QsfpSignalIntegrityLaneItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="List of qspf lane signal integrity.",
        default=None,
        alias="qsfp-signal-integrity-lane",
    )
...
class Pluggable(YangBaseModel):
    ...
    required_type: PluggableTypeEnum = Field(
        json_schema_extra={"is_config": True},
        description="The attribute indicates the equipment type to identify the module.\nNeeds to be re-defined in the project specific model.",
        alias="required-type",
    )
    form_factor: PluggableFormFactorEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicating the exact form factor of the pluggable.",
        default=PluggableFormFactorEnum.UNRECOGNIZED,
        alias="form-factor",
    )
    ...
    laser_source: LaserSourceEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="The type of laser frequency. Only tx-lo-independent type support och-os rx-frequency working\n\nCondition (when): ../required-type = 'CFP2'",
        default=LaserSourceEnum.NOT_AVAILABLE,
        alias="laser-source",
    )
    ...
    upgrade_fail_reasons: str | None = Field(
        json_schema_extra={"is_config": False},
        description="3rd party pluggle upgrade fail reason.",
        min_length=0,
        max_length=50,
        default=None,
        alias="upgrade-fail-reasons",
    )
    ...
    clei: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Identifies the CLEI code number of the equipment.\nThe CLEI code is a 10-character code that identifies\ncommunications equipment. It describes product type, features,\nsource document, and associated drawings and vintages.",
        min_length=0,
        max_length=18,
        default=None,
    )
    voltage: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The current voltage applied by the module. The current is\nexpressed in V with up to two decimal precision. Just\nsupply the instant value.",
        default=None,
    )
    channel_states: RestconfList[ChannelStatesItem] | None = Field(
        json_schema_extra={"is_config": False}, default=None, alias="channel-states"
    )
    diagnostic_alarm_thresholds: RestconfList[DiagnosticAlarmThresholdsItem] | None = Field(
        json_schema_extra={"is_config": False}, default=None, alias="diagnostic-alarm-thresholds"
    )
    equipment_name: str | None = Field(
        json_schema_extra={"is_config": True},
        description="The attribute indicates an additional field to identify the module.",
        min_length=0,
        max_length=64,
        default=None,
...
class Statistics(YangBaseModel):
    ...
    bit_error_fec: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics bits counting for error bit forward error correction, corresponding to pm parameter BE-FEC\n\nCondition (when): ../../port-mode != 'QPSK_100G_TRANSPARENT'",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="bit-error-fec",
    ...
    differential_group_delay: DifferentialGroupDelay | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="differential-group-delay",
    )
    chromatic_dispersion: ChromaticDispersion | None = Field(
        json_schema_extra={"is_config": False},
    ...
    polarization_dependent_loss: PolarizationDependentLoss | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="polarization-dependent-loss",
    )
    in_optical_frequency: InOpticalFrequency | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="in-optical-frequency",
    )
    out_optical_frequency: OutOpticalFrequency | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="out-optical-frequency",
    )
    sop_change_rate: SopChangeRate | None = Field(
        json_schema_extra={"is_config": False},
...
class OchOs(YangBaseModel):
    ...
    modulation_format: ModulationFormatEnum = Field(
        json_schema_extra={"is_config": True},
        description="Currently och-os modulation format",
    ...
    rate_class: RateClassEnum = Field(
        json_schema_extra={"is_config": True}, description="Carried OTN signal basic rate class", alias="rate-class"
    )
    frequency: int | None = Field(
        json_schema_extra={"is_config": True},
        description="The laser frequency. For tx-lo-independent laser-type, it set the tx laser frequency only.",
        le=196111250,
        ge=0,
        default=0,
    )
    actual_frequency: int | None = Field(
        json_schema_extra={"is_config": False},
    ...
    actual_rx_frequency: int | None = Field(
        json_schema_extra={"is_config": False},
    ...
    laser_enable: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The enable switching of output laser.",
        default=EnableSwitchEnum.DISABLED,
        alias="laser-enable",
    )
    required_tx_optical_power: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="This is to support adjustable optical power of Line side.",
        default=1.0,
        alias="required-tx-optical-power",
    )
    actual_tx_optical_power: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="This is the actual transmitting optical power of Line side.",
        default=-99.0,
        alias="actual-tx-optical-power",
    )
    fec_type: OtukFecEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The FEC type of och-os",
        default=OtukFecEnum.SDFEC25,
        alias="fec-type",
    )
    ...
    OSNR: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Current value of OSNR.\nThe result could be OSNR value with dB\n\nCondition (when): ../possible-pluggable-types != 'SFP+'",
        default=None,
    )
    Q_factor: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Current value of Q-factor\n\nCondition (when): ../possible-pluggable-types != 'SFP+'",
        default=None,
        alias="Q-factor",
    )
    pre_fec_ber: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
    ...
    cd_compensation_mode: CdCompensationModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="chromatic dispersion compensation value source mode\n\nCondition (when): ../possible-pluggable-types != 'SFP+'",
        default=CdCompensationModeEnum.AUTO,
    ...
    otuc2: Otuc2 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otuc2 object", default=None
    )
    otuc3: Otuc3 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otuc3 object", default=None
    )
    otuc4: Otuc4 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otuc6 object", default=None
    )
    otuc5: Otuc5 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otuc5 object", default=None
    )
    otuc6: Otuc6 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otuc6 object", default=None
    )
    otuc7: Otuc7 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otuc7 object", default=None
    )
    otuc9: Otuc9 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otuc9 object", default=None
    )
    otuc11: Otuc11 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otuc11 object", default=None
    )
    otu4: Otu4 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otu4 object", default=None
    )
    otu2: Otu2 | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otu2 object", default=None
    )
    otu2e: Otu2e | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the otu2e object", default=None
    )
...
class OtdrPort(YangBaseModel):
    ...
    otdr_range: str | float | None = Field(
        json_schema_extra={"is_config": True}, description="OTDR measurement range.", default="auto", alias="otdr-range"
    )
    otdr_pulse_width: str | int | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates pulse width to be used in otdr measurement.",
        default="auto",
        alias="otdr-pulse-width",
    )
    otdr_measurement_speed: OtdrMeasurementSpeedEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicating OTDR measurement speed.",
        default=OtdrMeasurementSpeedEnum.AUTO,
        alias="otdr-measurement-speed",
    )
    otdr_ior: str | float | None = Field(
        json_schema_extra={"is_config": True},
        description="Specifies the group index of refraction (IOR) of the fiber to be measured.",
        default="auto",
        alias="otdr-ior",
    )
    otdr_fiber_type: OtdrFiberTypeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicating fiber type to be measured.",
        default=OtdrFiberTypeEnum.AUTO,
    ...
    launching_fiber_length: str | float | None = Field(
        json_schema_extra={"is_config": True},
...
class MonitoredChannelsItem(YangBaseModel):
    ...
    frequency_index: int = Field(
        ...
        le=196111250,
        ge=0,
        alias="frequency-index",
    )
    channel_id: int | None = Field(
        json_schema_extra={"is_config": False},
        description="the optical och index.",
        ge=0,
        default=None,
        alias="channel-id",
    )
    monitored_center_frequency: int | None = Field(
        json_schema_extra={"is_config": False},
        description="Monitored channel center frequency.",
        le=196111250,
        ge=0,
        default=None,
        alias="monitored-center-frequency",
    )
    ...
    monitored_width: str | int | None = Field(
        json_schema_extra={"is_config": False},
...
class OcmPort(YangBaseModel):
    ...
    ocm_port_enable: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Enable or disable the function of ocm port measurement.",
        default=None,
        alias="ocm-port-enable",
    )
    grid_mode: GridTypeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates Grid type of the OMS.",
        default=GridTypeEnum.NOT_APPLICABLE,
        alias="grid-mode",
    )
    grid_offset: int | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates channel frequency offset to standard grid.",
        default=0,
        alias="grid-offset",
    )
    optical_power_offset: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="The offset to calibrate Optical power of monitored channels, resulted value = monitored value + offset.",
        default=None,
        alias="optical-power-offset",
    )
    channel_baud_rate: ChannelBaudRateEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The baud rate selection for monitored optical channel",
        default=None,
        alias="channel-baud-rate",
    )
    ppa_1dB_BW: int | None = Field(
        json_schema_extra={"is_config": True},
    ...
    monitored_channels: RestconfList[MonitoredChannelsItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="List of monitored channels",
        default=None,
        alias="monitored-channels",
    )
...
class Statistics(YangBaseModel):
    ...
    in_optical_power_lane_high: InOpticalPowerLaneHigh | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="in-optical-power-lane-high",
    )
    in_optical_power_lane_low: InOpticalPowerLaneLow | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="in-optical-power-lane-low",
    )
    in_optical_power_lane_total: InOpticalPowerLaneTotal | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="in-optical-power-lane-total",
    )
    out_optical_power_lane_high: OutOpticalPowerLaneHigh | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="out-optical-power-lane-high",
    )
    out_optical_power_lane_low: OutOpticalPowerLaneLow | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="out-optical-power-lane-low",
    )
    out_optical_power_lane_total: OutOpticalPowerLaneTotal | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=None,
        alias="out-optical-power-lane-total",
    )
    in_optical_power: InOpticalPower | None = Field(
        json_schema_extra={"is_config": False},
        description="statistics value: average, minimum, maximum and instant value for RX optical power, corresponding to pm parameter OPT",
...
class Eth1g(YangBaseModel):
    ...
    mac_address: str | None = Field(
        json_schema_extra={"is_config": True},
        description="The MAC address of the port for L2CP",
        default=None,
        alias="mac-address",
    )
    ...
    duplex: DuplexEnum | None = Field(
        json_schema_extra={"is_config": True}, description="Set duplex selections.", default=DuplexEnum.FULL
    )
    mtu: int | None = Field(
        json_schema_extra={"is_config": True}, description="Set Maximum Frame Size.", ge=1280, le=1500, default=1500
    )
    auto_negotiation: AutoNegotiationEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Set Auto Negotiation: Enabled/Disabled.",
        default=AutoNegotiationEnum.ENABLED,
        alias="auto-negotiation",
    )
    curr_speed: str | None = Field(
        json_schema_extra={"is_config": False},
        description="speed (UNKNOWN/AUTO/10/100/1000/10000) corresponding to the interface",
        default=None,
        alias="curr-speed",
    )
    curr_duplex: str | None = Field(
        json_schema_extra={"is_config": False},
    ...
    odu: RestconfList[OduItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Condition (when): (../port-type != 'osc') and (../port-type != 'mgmt-eth')",
        default=None,
    )
...
class PortItem(YangBaseModel):
    ...
    possible_pluggable_types: RestconfList[PluggableTypeEnum] | None = Field(
        json_schema_extra={"is_config": False},
        description="Defined all the pluggable types which can be equipped on the port.\nNeeds to be re-defined in the project specific model.\n\nCondition (when): (../port-type != 'optical') and (../port-type != 'otdr') and (../port-type != 'optical-nomon') and (../port-type != 'ocm') and (../port-type != 'mgmt-eth')",
        default=None,
        alias="possible-pluggable-types",
    )
    actual_pluggable_type: EquipmentTypeEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Pluggable type for each port according to the actually equipping.\nNeeds to be re-defined in the project specific model.\n\nCondition (when): (../port-type != 'optical') and (../port-type != 'ocm') and (../port-type != 'optical-nomon') and (../port-type != 'otdr') and (../port-type != 'mgmt-eth')",
        default=EquipmentTypeEnum.EMPTY,
        alias="actual-pluggable-type",
    )
    defect_optical_loss: bool | None = Field(
        json_schema_extra={"is_config": False},
        description="defect optical loss for the partner ports",
        default=None,
        alias="defect-optical-loss",
    )
    rx_optical_power: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Received optical power\n\nCondition (when): (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'mgmt-eth') and (direction-type != 'tx')",
        default=None,
        alias="rx-optical-power",
    )
    tx_optical_power: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Transmitted optical power\n\nCondition (when): (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'mgmt-eth') and (direction-type != 'rx')",
        default=None,
        alias="tx-optical-power",
    )
    rx_optical_power_selected_channel: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Optical power of the selected channel on coherent receiver,\nwhich will be different from the rx-optical-power when multiple channels input simultaneously.\n\nCondition (when): (port-type = 'line') and (possible-pluggable-types != 'SFP+')",
        default=None,
        alias="rx-optical-power-selected-channel",
    )
    optical_power_lane: RestconfList[OpticalPowerLaneItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="Condition (when): (port-type = 'client') and (possible-pluggable-types != 'SFP+')",
        default=None,
        alias="optical-power-lane",
    )
    direction_type: TypeOfDirectionEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Supported direction of the optical port.\n\nCondition (when): (port-type = 'optical') or (port-type = 'otdr') or (port-type = 'optical-nomon') or (port-type = 'ocm')",
    ...
    pluggable: Pluggable | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the Pluggable object\n\nCondition (when): (port-type != 'otdr') and (port-type != 'optical-nomon') and (port-type != 'ocm') and (port-type != 'optical') and (port-type != 'mgmt-eth')",
        default=None,
    )
    och_os: OchOs | None = Field(
        json_schema_extra={"is_config": True},
...
class SupportedGainRangeItem(YangBaseModel):
    ...
    range_type: GainRangeTypeEnum = Field(
        json_schema_extra={"is_config": False},
...
class AmplifierItem(YangBaseModel):
    ...
    amplifier_name: Annotated[
        ...
        min_length=1,
        max_length=32,
        alias="amplifier-name",
    )
    supporting_input_port: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Identifier of the supporting input port.",
        default=None,
        alias="supporting-input-port",
    )
    supporting_output_port: str | None = Field(
        json_schema_extra={"is_config": True},
    ...
    egress_average_channel_power: Decimal64 | None = Field(
        ...
        default=None,
        alias="egress-average-channel-power",
    )
...
class TdcItem(YangBaseModel):
    ...
    tdc_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
    ...
    tdc_mode: GainRangeControlEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    reference_frequency: int | None = Field(
        json_schema_extra={"is_config": True},
    ...
    actual_reference_frequency: int | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicating the actual reference wavelength of the TDC.",
        ge=0,
        default=None,
        alias="actual-reference-frequency",
    )
    frequency_range_min: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The minimum of supported wavelength.",
        ge=0,
        default=None,
        alias="frequency-range-min",
    )
    frequency_range_max: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The maximum of supported wavelength.",
        ge=0,
        default=None,
        alias="frequency-range-max",
    )
    chromatic_dispersion: int | None = Field(
        json_schema_extra={"is_config": True},
        description="The setting value of Chromatic Dispersion.",
        default=0,
        alias="chromatic-dispersion",
    )
    chromatic_dispersion_adjustment: int | None = Field(
        json_schema_extra={"is_config": True},
        ...
        default=None,
        alias="chromatic-dispersion-adjustment",
    )
    actual_chromatic_dispersion: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The actual value of Chromatic Dispersion.",
        default=None,
        alias="actual-chromatic-dispersion",
    )
    cd_range_min: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The minimum of supported chromatic dispersion.",
        default=None,
        alias="cd-range-min",
    )
    cd_range_max: int | None = Field(
        json_schema_extra={"is_config": False},
...
class OpsItem(YangBaseModel):
    ...
    ops_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
    ...
    active_path: ActivePathEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicating the active port of the protection switch.",
        default=ActivePathEnum.UNKNOWN,
        alias="active-path",
    )
    revertive: YesNoEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    wait_to_restore: int | None = Field(
        json_schema_extra={"is_config": True},
    ...
    holdoff_timer: int | None = Field(
        json_schema_extra={"is_config": True},
        description="The hold off time of the protection switch.",
        ge=0,
        le=1000,
        default=0,
        alias="holdoff-timer",
    ...
    wavelength_band: WavelengthBandEnum | None = Field(
        ...
        default=WavelengthBandEnum._1550,
        alias="wavelength-band",
    )
    ops_frequency: int | None = Field(
        json_schema_extra={"is_config": True},
        description="The frequency of optical protection frequency, which will decide the pilot tone modulated on the channel.",
        le=196111250,
        ge=0,
        default=0,
        alias="ops-frequency",
    )
    working_protection_relative_threshold: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="Specify the threshold of power difference between working path and protection path;\nSetting to value 0 to disable the power difference as switch criteria;\nSetting to non-zero value indicates the value of power difference between two paths will trigger protection switch.",
        default=0,
        alias="working-protection-relative-threshold",
    )
    relative_threshold_hysteresis: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="Specify relative threshold hysteresis for clearance of relative threshold crossing failure.",
        default=2.0,
        alias="relative-threshold-hysteresis",
    )
    relative_threshold_offset: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="Specify relative threshold offset for protection switch per power difference between working and protection,\nthe offset is the value of (working power - protection power), the offset value will be excluded from power\ndifference before comparing to relative threshold threshold and its hysteresis.",
        default=0.0,
        alias="relative-threshold-offset",
    )
...
class Statistics(YangBaseModel):
    ...
    module_temperature: ModuleTemperature | None = Field(
        json_schema_extra={"is_config": False},
...
class Subcard(YangBaseModel):
    ...
    required_type: CardTypeEnum = Field(
        json_schema_extra={"is_config": True},
        description="The attribute indicates the equipment type to identify the module.\nNeeds to be re-defined in the project specific model.",
        alias="required-type",
    )
    required_subtype: CardSubTypeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The attribute indicates the equipment sub type to identify the module, which is only appied to CHM2T currently.",
        default=CardSubTypeEnum.NOT_APPLICABLE,
    ...
    switching_type: SwitchingTypeEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="The traffic switching type of card.\n\nCondition (when): (../required-type != 'FAN') and (../required-type != 'PSU') and (../required-type != 'FRCU') and (../required-type != 'VIR-SIM')",
        default=SwitchingTypeEnum.OTN,
        alias="switching-type",
    )
    temperature: Decimal64 | None = Field(
        json_schema_extra={"is_config": False}, description="Temperature at the monitoring point.", default=None
    )
    ...
    tdc: RestconfList[TdcItem] | None = Field(
        json_schema_extra={"is_config": True}, description="The list of optical tdc on an equipment.", default=None
    )
...
class SubslotItem(YangBaseModel):
    ...
    subslot_id: int = Field(
        json_schema_extra={"is_config": True}, description="Identifier of the subslot.", ge=0, alias="subslot-id"
    )
    actual_card_type: EquipmentTypeEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Equipment type for each slot/subslot according to the actually equipping.\nNeeds to be re-defined in the project specific model.",
        default=EquipmentTypeEnum.EMPTY,
        alias="actual-card-type",
    )
    actual_card_subtype: CardSubTypeEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Equipment sub-type for each slot according to the actually equipping.\n\nCondition (when): ../actual-card-type = 'CHM2T'",
        default=CardSubTypeEnum.NOT_APPLICABLE,
        alias="actual-card-subtype",
    )
    possible_card_types: RestconfList[CardTypeEnum] | None = Field(
        json_schema_extra={"is_config": False},
        description="Defined all the equipment types which can be installed on the slot/subslot.",
        default=None,
    ...
    subcard: Subcard | None = Field(
        json_schema_extra={"is_config": True}, description="Subcard is a container carried by a subslot.", default=None
    )
...
class Card(YangBaseModel):
    ...
    card_mode: CardModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Specify the card mode, e.g. normal or regen.",
        default=CardModeEnum.NORMAL,
        alias="card-mode",
    )
    fan_speed_rate: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The fan speed of percentage.\n\nCondition (when): ../required-type = 'FAN'",
        ge=0,
        le=100,
        default=None,
        alias="fan-speed-rate",
    )
    latch_open: YesNoEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="The latch is opened or closed.",
        default=YesNoEnum.NO,
        alias="latch-open",
    )
    switching_type: SwitchingTypeEnum | None = Field(
    ...
    temperature_details: RestconfList[TemperatureDetailsItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="The detailed information of temperature in each monitoring-point of current module",
        default=None,
        alias="temperature-details",
    )
    cpu_state: CpuState | None = Field(
        json_schema_extra={"is_config": False},
        description="The module with CPU's utilization states",
        default=None,
        alias="cpu-state",
    )
    memory_state: MemoryState | None = Field(
        json_schema_extra={"is_config": False},
...
class SlotItem(YangBaseModel):
    ...
    reserved: bool | None = Field(
        json_schema_extra={"is_config": True},
        description="Describes whether this slot is reserved by a required card.\nThis is true for both cards in current slot, or in adjancent slots.",
        default=False,
    )
    actual_card_type: EquipmentTypeEnum | None = Field(
        json_schema_extra={"is_config": False},
    ...
    card: Card | None = Field(
        json_schema_extra={"is_config": True}, description="Card is a container carried by a slot.", default=None
    )
...
class Statistics(YangBaseModel):
    ...
    inlet_temperature: InletTemperature | None = Field(
        json_schema_extra={"is_config": True},
        ...
        default=None,
        alias="inlet-temperature",
    )
    outlet_temperature: OutletTemperature | None = Field(
        json_schema_extra={"is_config": True},
...
class ShelfItem(YangBaseModel):
    ...
    shelf_serial_number: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Serial number of the shelf.",
        min_length=0,
        max_length=64,
        default=None,
        alias="shelf-serial-number",
    )
    shelf_location: str | None = Field(
        ...
        max_length=64,
        default=None,
        alias="shelf-location",
    )
    shelf_mac_address: str | None = Field(
        json_schema_extra={"is_config": True},
        description="The MAC address of the shelf",
        default=None,
        alias="shelf-mac-address",
    )
    shelf_linklocal_ip_address: str | None = Field(
        json_schema_extra={"is_config": True},
        description="The link local IP address of the shelf, which is used during the shelf topology establishment phase",
        default=None,
        alias="shelf-linklocal-ip-address",
    )
    shelf_ip_address: str | None = Field(
        json_schema_extra={"is_config": True},
        description="The IP address of the shelf, which is assigned by the main shelf",
        default=None,
        alias="shelf-ip-address",
    )
    flush_l2_addr_table: int | None = Field(
        json_schema_extra={"is_config": True},
        description="Flush the L2 MAC address table of the shelf",
        ge=0,
        default=0,
    )
    unknown_pluggable_report: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The attribute will enable/disable the alarm reporting for unknown pluggables present on the NE.",
        default=EnableSwitchEnum.ENABLED,
        alias="unknown-pluggable-report",
    )
    los_alarm_soak_time: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="enable or disable the function of los-alarm-soak-time. By default it's enabled, which means LOS detection still have soak time.",
        default=EnableSwitchEnum.ENABLED,
        alias="los-alarm-soak-time",
    )
    highest_alarm_severity: SeverityLevelEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The highest severity of any active alarm on any object under this shelf (or ne if this is the main shelf).\nThis is used to configure the FAULT LED of the shelf.",
        default=SeverityLevelEnum.NOT_ALARMED,
        alias="highest-alarm-severity",
    )
    inlet_temperature: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="shelf inlet temperature",
        default=None,
        alias="inlet-temperature",
    )
    outlet_temperature: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
...
class InventoryItem(YangBaseModel):
    ...
    equipment_type: EquipmentTypeEnum_1 = Field(
        json_schema_extra={"is_config": False},
        description="The equipment type that the inventory data refers to",
        alias="equipment-type",
    )
    shelf_id: int = Field(
        json_schema_extra={"is_config": False}, description="Identifier of the shelf.", ge=1, alias="shelf-id"
    )
    slot_id: int = Field(
        json_schema_extra={"is_config": False}, description="Identifier of the slot.", ge=0, alias="slot-id"
    )
    subslot_id: int = Field(
        json_schema_extra={"is_config": False}, description="Identifier of the subslot.", ge=0, alias="subslot-id"
    )
    port_id: int = Field(
        json_schema_extra={"is_config": False}, description="Identifier of the port.", ge=0, alias="port-id"
    )
    equipment_version: str | None = Field(
        json_schema_extra={"is_config": False},
        description="The attribute Identifies the Hardware Version of the module that populates the slot.",
        min_length=0,
        max_length=20,
        default=None,
        alias="equipment-version",
    )
...
class LedItem(YangBaseModel):
    ...
    led_name: str = Field(
        json_schema_extra={"is_config": False},
        description="The functional name of LED.\nDCI NE:\nlocation_led\nport(n)_led   (CHM1: n = 1 to 6, CHM2 n = 1 to 12, e.g. Port12)\nactive_led\npower_led\nfault_led\nstatus_led\nsubslot(n)_led",
        min_length=0,
        max_length=16,
        alias="led-name",
    )
    led_status: LedStatusEnum | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=LedStatusEnum.NOT_AVAILABLE,
        alias="led-status",
    )
...
class Leds(YangBaseModel):
    ...
    led: RestconfList[LedItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="Attributes related with LED\nApplicable to Shelf, FAN, PSU, CHM1, CHM2, CHM1G, OCC2 in DCI.",
        default=None,
    )
...
class CrsItem(YangBaseModel):
    ...
    src_tp: str = Field(
        json_schema_extra={"is_config": True}, description="Source tp of cross connection.", alias="src-tp"
    )
    dst_tp: str = Field(
        json_schema_extra={"is_config": True}, description="Destination tp of cross connection.", alias="dst-tp"
    )
    service_label: str | None = Field(
        json_schema_extra={"is_config": True},
...
class FiberConnectionItem(YangBaseModel):
    ...
    src_port: str = Field(
        json_schema_extra={"is_config": True}, description="Source port of fiber connection.", alias="src-port"
    )
    dst_port: str = Field(
        json_schema_extra={"is_config": True}, description="Destination port of fiber connection.", alias="dst-port"
    )
    fiber_connection_type: FiberConnectionTypeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates fiber connection type.",
        default=FiberConnectionTypeEnum.TWO_WAY,
        alias="fiber-connection-type",
    )
    fiber_label: str | None = Field(
        json_schema_extra={"is_config": True},
...
class InternalLinkItem(YangBaseModel):
    ...
    internal_link_name: str = Field(
        json_schema_extra={"is_config": False}, min_length=1, max_length=255, alias="internal-link-name"
    )
...
class OtsItem(YangBaseModel):
    ...
    ots_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
    ...
    supporting_rx_port: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Supporting Rx port for the optical interface.",
        default=None,
        alias="supporting-rx-port",
    )
    supporting_tx_port: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Supporting Tx port for the optical interface.",
        default=None,
        alias="supporting-tx-port",
    )
    measured_span_loss_receive: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The received measured span loss excluding offset.",
        default=99,
        alias="measured-span-loss-receive",
    )
    measured_span_loss_transmit: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The transmit measured span loss excluding offset.",
        default=99,
        alias="measured-span-loss-transmit",
    )
    fiber_spectral_attenuation_tilt: str | float | None = Field(
        json_schema_extra={"is_config": True},
        description="Specifies the Fiber Spectral Attenuation Tilt.",
        default="unspecified",
        alias="fiber-spectral-attenuation-tilt",
    )
    raman_tilt_coefficient: str | float | None = Field(
        json_schema_extra={"is_config": True},
        description="Specifies the Fiber Spectral Attenuation Tilt.",
        default="unspecified",
        alias="raman-tilt-coefficient",
    )
    fiber_type: FiberTypeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicating fiber type of the OTS span.",
        default=FiberTypeEnum.SSMF,
        alias="fiber-type",
    )
    external_tx_attenuation: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="External padding attenuation at transmitting direction.",
        default=None,
        alias="external-tx-attenuation",
    )
    ...
    fiber_length_tx_derived: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Derived fiber length of transmitting direction.",
        default=None,
        alias="fiber-length-tx-derived",
    )
    fiber_length_rx: str | float | None = Field(
        json_schema_extra={"is_config": True},
        description="Specify the fiber length of received direction.",
        default="auto",
        alias="fiber-length-rx",
    )
    fiber_length_rx_derived: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Derived fiber length of recieved direction.",
        default=None,
        alias="fiber-length-rx-derived",
    )
    span_degrade_enable: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="switching for span degrade shutdown function",
        default=EnableSwitchEnum.DISABLED,
        alias="span-degrade-enable",
    )
    span_degrade_loss: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="The degrade threhsold for recieved span loss",
        default=28,
        alias="span-degrade-loss",
    )
    span_degrade_hysteresis: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="The hysteresis of optical revocery threshold of recieved",
        default=2,
        alias="span-degrade-hysteresis",
    )
    ...
    ingress_span_loss_aging_margin: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        ...
        default=0,
        alias="ingress-span-loss-aging-margin",
    )
    eol_max_load_pIn: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
    ...
    ots_diagnostics: OtsDiagnostics | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="ots-diagnostics"
    )
...
class OmsItem(YangBaseModel):
    ...
    oms_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
    ...
    oms_working_mode: ChannelWorkingModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The oms working mode for FOADM scenario\n\nCondition (when): deref(../supporting-rx-port)/../switching-type = 'amplifier'",
        default=ChannelWorkingModeEnum.NO_MONITOR,
        alias="oms-working-mode",
    )
    supporting_rx_port: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Supporting Rx port for the optical interface.",
    ...
    parent_ots_interface: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Supporting OTS interface.",
        default=None,
        alias="parent-ots-interface",
    )
    service_label: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Path/service name of cross-connection related facility.",
    ...
    rx_optical_power: str | float | None = Field(
        json_schema_extra={"is_config": False},
        description="Received optical power",
        default="not-available",
        alias="rx-optical-power",
    )
    tx_optical_power: str | float | None = Field(
        json_schema_extra={"is_config": False},
        description="Transmitted optical power",
        default="not-available",
        alias="tx-optical-power",
    ...
    input_channel_attenuation_control_mode: AttControlModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Specify attenuation control mode of the channel which applicable to all channels of the oms.",
        default=None,
        alias="input-channel-attenuation-control-mode",
    )
    output_channel_attenuation_control_mode: AttControlModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Specify attenuation control mode of the channel which applicable to all channels of the oms.",
        default=AttControlModeEnum.AUTO,
        alias="output-channel-attenuation-control-mode",
    )
    statistics: Statistics | None = Field(json_schema_extra={"is_config": False}, default=None)
...
class Statistics(YangBaseModel):
    ...
    delay_measurement_distance: DelayMeasurementDistance | None = Field(
        json_schema_extra={"is_config": False},
        description="statistics value: average, minimum, maximum and instant value for delay measurement distance, corresponding to pm parameter DM-Distance",
        default=None,
        alias="delay-measurement-distance",
    )
    round_trip_delay: RoundTripDelay | None = Field(
        json_schema_extra={"is_config": False},
        description="statistics value: average, minimum, maximum and instant value for round trip delay, corresponding to pm parameter RTD",
        default=None,
        alias="round-trip-delay",
    )
    rtd_baseline: RtdBaseline | None = Field(
        json_schema_extra={"is_config": False},
        description="statistics value: average, minimum, maximum and instant value for round trip delay baseline, corresponding to pm parameter RTD-Baseline",
        default=None,
        alias="rtd-baseline",
    )
    in_coding_violation: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics bits counting for ingress coding violation, corresponding to pm parameter CV\n\nCondition (when): deref(../supporting-rx-port)/../required-type = 'RD09SM'",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="in-coding-violation",
...
class OscItem(YangBaseModel):
    ...
    osc_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
    ...
    osc_laser_on: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="enable or disable OSC",
        default=EnableSwitchEnum.ENABLED,
        alias="osc-laser-on",
    )
    osc_mode: OscModeEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicating the current OSC mode.",
        default=OscModeEnum._155M52,
        alias="osc-mode",
    )
    osc_wavelength: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the wavelength band of the OSC channel.",
        ge=950.0,
        le=1700.0,
        default=1510,
        alias="osc-wavelength",
    )
    osc_data_communication: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Configuration for enable or disable data communication network support of the OSC.",
        default=EnableSwitchEnum.ENABLED,
        alias="osc-data-communication",
    )
    rtd_measurement: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Configuration for enable or disable round trip delay measurement via the OSC.",
        default=EnableSwitchEnum.ENABLED,
        alias="rtd-measurement",
    )
    rtd_interval: Uint64 | None = Field(
        json_schema_extra={"is_config": True},
        description="The time interval of the measurement message sent.",
        ge=1,
        le=600,
        default=5,
        alias="rtd-interval",
    )
    rtd_tx_msg: Uint64 | None = Field(
        json_schema_extra={"is_config": True},
        description="The number of measurement messages to be sent, fixed as 1.",
        ge=0,
        le=18446744073709551615,
        default=1,
        alias="rtd-tx-msg",
    )
    rtd_est_baseline: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics of estimated length of the measured OSC span in kilometers to be stored in the baseline file",
        default=None,
        alias="rtd-est-baseline",
    )
    rtd_min_distance: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics of minimum measureable distance which can be measured using OSC RTD",
        default=None,
        alias="rtd-min-distance",
    )
    rtd_tx: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting of the transmit messages sent",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="rtd-tx",
    )
    rtd_rx: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="the statistics counting of the reply messages received",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="rtd-rx",
...
class Statistics(YangBaseModel):
    ...
    protection_switch_duration: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Protection Switch Duration, corresponding to pm parameter PSD",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="protection-switch-duration",
    )
    protection_switch_count: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Protection Switch Count, corresponding to pm parameter PSC",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="protection-switch-count",
    )
    loss_tx: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
...
class GoptItem(YangBaseModel):
    ...
    gopt_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
...
class OchInput(YangBaseModel):
    ...
    input_channel_attenuation_control_mode: AttControlModeEnum | None = Field(
        ...
        default=AttControlModeEnum.NOT_APPLICABLE,
        alias="input-channel-attenuation-control-mode",
    )
    actual_attenuation: str | float | None = Field(
        json_schema_extra={"is_config": False},
        description="Actually setting attenuation.",
        default="not-available",
        alias="actual-attenuation",
    )
    target_attenuation: str | float | None = Field(
        json_schema_extra={"is_config": True},
        description="Actually setting attenuation.",
        default="6",
        alias="target-attenuation",
    )
    intended_attenuation: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="the attenuation value for pcl output",
        default=200.0,
        alias="intended-attenuation",
    )
...
class OchItem(YangBaseModel):
    ...
    och_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
    ...
    och_wavelength: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Wavelength of the channel with unit nm.",
        default=None,
        alias="och-wavelength",
    )
    input_power_typical: str | float | None = Field(
        json_schema_extra={"is_config": True},
        description="Typical input power required for reliable channel detection.",
        default="not-specified",
        alias="input-power-typical",
    )
    och_width: int | None = Field(
        json_schema_extra={"is_config": True},
    ...
    och_working_mode: ChannelWorkingModeEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="och power control function mode\n\nCondition (when): name(deref(../parent-entity)) = 'oms'",
        default=ChannelWorkingModeEnum.NO_MONITOR,
        alias="och-working-mode",
    )
    rx_optical_power: str | float | None = Field(
        json_schema_extra={"is_config": False},
        description="Received optical power",
    ...
    och_optical_attenuation: OchOpticalAttenuation | None = Field(
        json_schema_extra={"is_config": True},
        description="Container for channel attenuation attributes used for function of per channel attenuation control, e.g. on DGE",
        default=None,
        alias="och-optical-attenuation",
    )
...
class McItem(YangBaseModel):
    ...
    mc_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
    ...
    parent_entity: str = Field(
        json_schema_extra={"is_config": True}, description="Specify supporting parent entity.", alias="parent-entity"
    )
...
class NmcItem(YangBaseModel):
    ...
    nmc_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
    ...
    input_power_max: str | float | None = Field(
        json_schema_extra={"is_config": True},
        description="the maximum valid input signal power\n\nCondition (when): ../../../roadm-target-power-mode = 'power'",
        default="not-available",
        alias="input-power-max",
    )
    input_power_min: str | float | None = Field(
        json_schema_extra={"is_config": True},
        description="the minimum valid input signal power\n\nCondition (when): ../../../roadm-target-power-mode = 'power'",
        default="not-available",
        alias="input-power-min",
    )
    peer_nmc: str | None = Field(
        json_schema_extra={"is_config": True},
        description="hmo for covert nmc record the peer nmc in OCRS",
        default=None,
        alias="peer-nmc",
    )
    rx_optical_power: str | float | None = Field(
    ...
    nmc_optical_attenuation: NmcOpticalAttenuation | None = Field(
        json_schema_extra={"is_config": True},
        description="Container for channel attenuation attributes used for function of per channel attenuation control, e.g. on WSS",
        default=None,
        alias="nmc-optical-attenuation",
    )
    statistics: Statistics | None = Field(json_schema_extra={"is_config": False}, default=None)
...
class OpticalInterfaces(YangBaseModel):
    ...
    gopt: RestconfList[GoptItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the Generic Optical Section Interface (GOPT) MO",
        default=None,
    )
    och: RestconfList[OchItem] | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the Optical Channel (OCH) MO", default=None
    )
    mc: RestconfList[McItem] | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the  Media Channel (MC) MO", default=None
    )
    nmc: RestconfList[NmcItem] | None = Field(
        json_schema_extra={"is_config": True}, description="Represents the Network Media Channel (NMC) MO", default=None
    )
...
class OcrsItem(YangBaseModel):
    ...
    src_if: str = Field(
        json_schema_extra={"is_config": True}, description="Source tp of cross connection.", alias="src-if"
    )
    dst_if: str = Field(
        json_schema_extra={"is_config": True}, description="Destination tp of optical cross connection.", alias="dst-if"
    )
    optical_connection_type: FiberConnectionTypeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates the cross connection type.",
        default=FiberConnectionTypeEnum.ONE_WAY,
        alias="optical-connection-type",
    )
    target_psd_dst: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        ...
        default=None,
        alias="target-psd-dst",
    )
    target_psd_src: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="Source interface power spectral density expressed in nanowatts per\ngigahertz, nW/GHz.  These units allow the value to often\nbe greater than 1.0.  It also avoids dealing with zero values\nfor 0dBm.  For example, a 40GHz wide channel\nwith 0dBm power would be:\n0dBm = 1mW = 10^6nW\n0dBm/40GHz = 10^6nW/40GHz = 1000000/40 = 25000\n\nCondition (when): (../optical-connection-type = 'two-way') and (../../roadm-target-power-mode = 'psd')",
        default=None,
        alias="target-psd-src",
    )
    ...
    target_actual_output_power_dst: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The destination interface target power\n\nCondition (when): ../../roadm-target-power-mode = 'power'",
        default=None,
        alias="target-actual-output-power-dst",
    )
    target_actual_output_power_src: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="The source interface target power\n\nCondition (when): ../../roadm-target-power-mode = 'power'",
        default=None,
        alias="target-actual-output-power-src",
    )
    target_actual_psd_dst: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Destination interface power spectral density expressed in nanowatts per\nmegahertz, nW/GHz.  These units allow the value to often\nbe greater than 1.0.  It also avoids dealing with zero values\nfor 0dBm.  For example, a 40GHz wide channel\nwith 0dBm power would be:\n0dBm = 1mW = 10^6nW\n0dBm/40GHz = 10^6nW/40GHz = 1000000/40 = 25000\n\nCondition (when): ../../roadm-target-power-mode = 'psd'",
        default=None,
        alias="target-actual-psd-dst",
    )
    target_actual_psd_src: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Source interface power spectral density expressed in nanowatts per\ngigahertz, nW/GHz.  These units allow the value to often\nbe greater than 1.0.  It also avoids dealing with zero values\nfor 0dBm.  For example, a 40GHz wide channel\nwith 0dBm power would be:\n0dBm = 1mW = 10^6nW\n0dBm/40GHz = 10^6nW/40GHz = 1000000/40 = 25000\n\nCondition (when): (../optical-connection-type = 'two-way') and (../../roadm-target-power-mode = 'psd')",
        default=None,
    ...
    stage_dst: str | None = Field(
        json_schema_extra={"is_config": True},
        description="record the stage of ocrs for dst.",
        min_length=0,
        max_length=32,
        default="not-applicable",
        alias="stage-dst",
    )
    stage_src: str | None = Field(
        json_schema_extra={"is_config": True},
        description="record the stage of ocrs for dst.",
        min_length=0,
        max_length=32,
    ...
    actual_psd_dst: Decimal64 | None = Field(
        json_schema_extra={"is_config": True}, description="hmo", default=0, alias="actual-psd-dst"
    )
    actual_psd_src: Decimal64 | None = Field(
        json_schema_extra={"is_config": True}, description="hmo", default=0, alias="actual-psd-src"
    )
    alias_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9_\\-/,\\.]*)$", v))] | None = (
        Field(
            json_schema_extra={"is_config": True},
...
class McCapabilities(YangBaseModel):
    ...
    slot_width_granularity: str | int | None = Field(
        json_schema_extra={"is_config": False},
        description="Width of a slot measured in MHz.",
        default="50000",
        alias="slot-width-granularity",
    )
    center_freq_granularity: str | int | None = Field(
        json_schema_extra={"is_config": False},
...
class DegreeItem(YangBaseModel):
    ...
    group_status: str | None = Field(
        json_schema_extra={"is_config": False},
        description="The group status for ROADM",
        default=None,
        alias="group-status",
    )
    modules: RestconfList[ModulesItem] | None = Field(
        json_schema_extra={"is_config": True}, description="list for Cards associated with a degree", default=None
    )
    ...
    associated_otdr_port: AssociatedOtdrPort | None = Field(
        json_schema_extra={"is_config": True},
        description="otdr port associated with degree.",
        default=None,
        alias="associated-otdr-port",
    )
    mc_capabilities: McCapabilities | None = Field(
        json_schema_extra={"is_config": False},
...
class SharedRiskGroupItem(YangBaseModel):
    ...
    wavelength_duplication: WavelengthDuplicationEnum | None = Field(
        ...
        default=WavelengthDuplicationEnum.ONE_PER_SRG,
        alias="wavelength-duplication",
    )
    grid_capability: GridCapabilityEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The srg grid capability selected by request",
        default=GridCapabilityEnum.COLORLESS,
        alias="grid-capability",
    )
    group_status: str | None = Field(
        json_schema_extra={"is_config": False},
        description="The group status for ROADM",
    ...
    modules: RestconfList[ModulesItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="list for Cards associated with an add/drop group and srg",
        default=None,
    )
    mc_capabilities: McCapabilities | None = Field(
        json_schema_extra={"is_config": False},
...
class Services(YangBaseModel):
    ...
    roadm_target_power_mode: RoadmTargetPowerModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The optical power control mode of ocrs",
        default=RoadmTargetPowerModeEnum.POWER,
        alias="roadm-target-power-mode",
    )
    span_loss_correction_mode: SpanLossCorrectionModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="for user to weight between fast span loss control versus safeguarding from accidental traffic impact when OSC fiber maintenance is conducted but the recommended procedure is not followed.",
        default=SpanLossCorrectionModeEnum.FAST,
        alias="span-loss-correction-mode",
    )
    CRS: RestconfList[CrsItem] | None = Field(
        json_schema_extra={"is_config": True}, description="Cross connection table.", default=None
    )
    fiber_connection: RestconfList[FiberConnectionItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Fiber connection table which will be user managed and be explicitly provisioned by user.\nFiber Connection indicates the physical fiber connection between physical ports or subports.",
        default=None,
        alias="fiber-connection",
    )
    internal_link: RestconfList[InternalLinkItem] | None = Field(
        json_schema_extra={"is_config": False}, default=None, alias="internal-link"
    )
    optical_interfaces: OpticalInterfaces | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the optical-interface MO",
        default=None,
        alias="optical-interfaces",
    )
    OCRS: RestconfList[OcrsItem] | None = Field(
        json_schema_extra={"is_config": True}, description="Cross connection table.", default=None
    )
    degree: RestconfList[DegreeItem] | None = Field(json_schema_extra={"is_config": True}, default=None)
    shared_risk_group: RestconfList[SharedRiskGroupItem] | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="shared-risk-group"
    )
...
class AlarmProfileEntryItem(YangBaseModel):
    ...
    condition_type: ConditionTypeEnum = Field(
        json_schema_extra={"is_config": True},
        description="Identifies the current standing conditions which cause conditions and/or events.",
        alias="condition-type",
    )
    fm_entity_type: EntityTypeFmEnum = Field(
        json_schema_extra={"is_config": True},
        description="Indicates the entity type the condition associated, which provides additional information for the object instance having the condition.\nentity type is not exactly same as MO. Entity type have smaller granularity referring to\ndifferent service functions, e.g. 100GBase-R, 40GBase-R, 100GBase-R, ODU4, ODU2, ODU3, OTU4, OTUC2...\nSeparate functions will have different entity types so that profile can be set differently for different\nservice function which is more corresponding to user application.",
        alias="fm-entity-type",
    )
    time_period: ManagementTimePeriodEnum = Field(
        json_schema_extra={"is_config": True},
        description="Indicates the time-period increments during which PM data is collected.",
        alias="time-period",
    )
    severity_level_sa: SeverityLevelEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates the notification code (severity level) associated with the condition type of service affecting.",
        default=None,
        alias="severity-level-sa",
    )
    severity_level_nsa: SeverityLevelEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates the notification code (severity level) associated with the condition type of non-service affecting.",
        default=None,
        alias="severity-level-nsa",
    )
...
class AlarmProfileItem(YangBaseModel):
    ...
    alarm_profile_id: int = Field(
        json_schema_extra={"is_config": True},
        description="alarm profile identifier which uniquely specify alarm profile.\nalarm profile 1 is supported firstly and applicable to all entities implicitly.",
        ge=1,
        le=255,
        alias="alarm-profile-id",
    )
    alarm_profile_entry: RestconfList[AlarmProfileEntryItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="The list includes alarm/event entries of an alarm-profile.",
        default=None,
        alias="alarm-profile-entry",
    )
...
class StandingConditionItem(YangBaseModel):
    ...
    location: ManagementLocationEnum = Field(
        json_schema_extra={"is_config": False},
        description="Indicates if the alarm or event location is near end or far end.",
    )
    direction: ManagementDirectionEnum = Field(
        json_schema_extra={"is_config": False},
        description="Specifies the direction of an event/occurrence in the system, Ingress, Egress, NA.",
    )
    time_period: ManagementTimePeriodEnum = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the time-period increments during which PM data is collected.",
    ...
    service_affect: ServiceAffectFmEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates if an alarm is service affecting or non-service affecting.\nNSA indicates non-service affecting.\nSA indicates service affecting.",
        default=None,
        alias="service-affect",
    )
    severity_level: SeverityLevelEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the notification code (severity level) associated with the alarm type of service affecting.",
        default=None,
        alias="severity-level",
    )
    occurrence_date_time: (
        ...
        default=None,
        alias="occurrence-date-time",
    )
    condition_description: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Describes the condition that caused the alarm.",
        min_length=0,
        max_length=255,
        default=None,
        alias="condition-description",
    )
    fm_entity_type: EntityTypeFmEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the entity type the condition associated, which provides additional information for the object instance having the condition.\nentity type is not exactly same as MO. Entity type have smaller granularity referring to\ndifferent service functions, e.g. 100GBase-R, 40GBase-R, 100GBase-R, ODU4, ODU2, ODU3, OTU4, OTUC2...\nSeparate functions will have different entity types so that profile can be set differently for different\nservice function which is more corresponding to user application.",
        default=None,
        alias="fm-entity-type",
...
class Fault(YangBaseModel):
    ...
    alarm_profile: RestconfList[AlarmProfileItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Alarm profile defines the severity profile of alarm and event.",
        default=None,
        alias="alarm-profile",
    )
    standing_condition: RestconfList[StandingConditionItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="The list includes active standing alarms.",
        default=None,
        alias="standing-condition",
    )
...
class PmThresholds(YangBaseModel):
    ...
    pm_thresholds_value: RestconfList[PmThresholdsValueItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="The list of entries of performance monitoring threshold value.",
        default=None,
        alias="pm-thresholds-value",
    )
...
class PmPointItem(YangBaseModel):
    ...
    supervision_switch: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Enable/disable counting for all performance monitoring parameters of the given PMP.",
        default=EnableSwitchEnum.DISABLED,
        alias="supervision-switch",
    )
    thresholding_switch: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        ...
        default=EnableSwitchEnum.DISABLED,
        alias="thresholding-switch",
    )
    history_recording: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Enable/disable the history data storage for all performance monitoring parameters of the given PM point.",
        default=EnableSwitchEnum.ENABLED,
        alias="history-recording",
    )
    pm_thresholds: PmThresholds | None = Field(
        json_schema_extra={"is_config": True},
        description="Containing the pm thresholds corresponding to each performance monitoring parameter.",
        default=None,
        alias="pm-thresholds",
    )
...
class Performance(YangBaseModel):
    ...
    pmdaystart: int | None = Field(
        json_schema_extra={"is_config": True},
        description="Specifies the hour of starting collecting 1-DAY monitoring parameters.\nTo reset the NE clock to the default value of 00:00 hours, the parameter should contain the value 0.",
        ge=0,
        le=23,
        default=0,
    )
    statistics_enable: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The global switch for all system statistics data collection.",
        default=EnableSwitchEnum.ENABLED,
        alias="statistics-enable",
    )
    pm_point: RestconfList[PmPointItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class ShelfPowerConsumptionItem(YangBaseModel):
    ...
    power_consumption_current: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Current power consumption of the system.",
        default=None,
        alias="power-consumption-current",
    )
    power_consumption_estimated_max: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Derived maximal power consumption around room temperature.",
        default=None,
        alias="power-consumption-estimated-max",
    )
...
class PowerConsumption(YangBaseModel):
    ...
    shelf_power_consumption: RestconfList[ShelfPowerConsumptionItem] | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="shelf-power-consumption"
    )
...
class L2Dcn(YangBaseModel):
    ...
    ip_address: str = Field(
        json_schema_extra={"is_config": True}, description="IP Address of device", alias="ip-address"
    )
    ...
    default_gateway: str | None = Field(
        json_schema_extra={"is_config": True}, description="Default Gateway", default=None, alias="default-gateway"
    )
    source: SourceEnum | None = Field(json_schema_extra={"is_config": False}, default=None)
    current_ip_address: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Current IP Address of device",
        default=None,
        alias="current-ip-address",
    )
    current_prefix_length: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The current length of the subnet prefix",
        ge=0,
        le=128,
        default=None,
        alias="current-prefix-length",
    )
    current_default_gateway: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Current Default Gateway",
        default=None,
        alias="current-default-gateway",
    )
    mac_address: (
        Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5})$", v))] | None
    ) = Field(
        json_schema_extra={"is_config": False}, description="MAC Address of device", default=None, alias="mac-address"
    )
...
class Ethernet(YangBaseModel):
    ...
    eth_port_id: int | None = Field(
        json_schema_extra={"is_config": True},
        description="The port ID in ethernet driver.",
        ge=0,
        default=0,
        alias="eth-port-id",
    )
    eth_resource_ref: str = Field(
        json_schema_extra={"is_config": True},
        description="Reference of the lower layer resource associated with this interface.",
        alias="eth-resource-ref",
    )
    alias_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9_\\-/,\\.]*)$", v))] | None = (
        Field(
            json_schema_extra={"is_config": True},
...
class Ppp(YangBaseModel):
    ...
    ppp_type: PppTypeEnum = Field(
        json_schema_extra={"is_config": True},
        description="Specifies the link type associated with the ppp.",
        alias="ppp-type",
    )
    negotiated_ppp_mru: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The PPP MRU after nogotiation with peer.",
        ge=64,
        le=1500,
        default=1500,
        alias="negotiated-ppp-mru",
    )
    peer_ip_address: (
        Annotated[
            str,
        ...
        default="0.0.0.0",
        alias="peer-ip-address",
    )
    ppp_pf_ref: str = Field(
        json_schema_extra={"is_config": True}, description="Reference of the ppp profile.", alias="ppp-pf-ref"
    )
    ppp_resource_ref: str = Field(
        json_schema_extra={"is_config": True},
        description="Reference of the lower layer resource associated with this interface.",
        alias="ppp-resource-ref",
    )
    alias_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9_\\-/,\\.]*)$", v))] | None = (
        Field(
            json_schema_extra={"is_config": True},
...
class IpAddress(YangBaseModel):
    ...
    ] = Field(json_schema_extra={"is_config": True}, description="The IP address on the interface.")
    origin: OriginEnum | None = Field(
        json_schema_extra={"is_config": False}, description="The origin of this address.", default=OriginEnum.STATIC
    )
    prefix_length: int = Field(
        json_schema_extra={"is_config": True},
        description="The length of the subnet prefix.",
...
class Ipv4(YangBaseModel):
    ...
    ipv4_address_assignment_method: SourceEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    ip_unnumbered: IpUnnumbered | None = Field(
        json_schema_extra={"is_config": True},
...
class Ipv6(YangBaseModel):
    ...
    ipv6_address_assignment_method: Ipv6AddressAssignmentMethodEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="IPv6 address assignment method.",
        default=Ipv6AddressAssignmentMethodEnum.AUTOCONFIG,
...
class Oscx(YangBaseModel):
    ...
    oscx_channel: OscxChannelEnum = Field(
        json_schema_extra={"is_config": True},
        description="Specifies the OSCX channel within the Optical Supervisory Channel.",
        alias="oscx-channel",
    )
    oscx_resource_ref: str = Field(
        json_schema_extra={"is_config": True},
        description="Reference of the lower layer resource associated with this interface.",
        alias="oscx-resource-ref",
    )
    alias_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9_\\-/,\\.]*)$", v))] | None = (
        Field(
            json_schema_extra={"is_config": True},
...
class InterfaceItem(YangBaseModel):
    ...
    ethernet: Ethernet | None = Field(
        json_schema_extra={"is_config": True},
        description="The Ethernet attributes of an Ethernet interface.\n\nCondition (when): ../if-type = 'ethernetCsmacd'",
        default=None,
    )
    ppp: Ppp | None = Field(
        json_schema_extra={"is_config": True}, description="Condition (when): ../if-type = 'ppp'", default=None
    )
    ipv4: Ipv4 | None = Field(
        json_schema_extra={"is_config": True}, description="Parameters for the IPv4 address family.", default=None
    )
    ipv6: Ipv6 | None = Field(
        json_schema_extra={"is_config": True}, description="Parameters for the IPv6 address family.", default=None
    )
    oscx: Oscx | None = Field(
        json_schema_extra={"is_config": True},
        description="OSCX (Optical Supervisory Channel Extended) interface\n\nCondition (when): ../if-type = 'oscx'",
        default=None,
    )
...
class NextHopItem(YangBaseModel):
    ...
    outgoing_interface: str = Field(
        json_schema_extra={"is_config": True},
        description="Reference of the outgoing interface.",
        alias="outgoing-interface",
    )
    ...
    metric: int | None = Field(
        json_schema_extra={"is_config": True}, description="metric of the next-hop.", ge=0, default=0
    )
...
class StaticRouteItem(YangBaseModel):
    ...
    destination_prefix: str = Field(
        json_schema_extra={"is_config": True}, description="IP destination prefix.", alias="destination-prefix"
    )
...
class OspfAdjacencyItem(YangBaseModel):
    ...
    ospf_neighbor_address: Annotated[
        str,
        AfterValidator(
            lambda v: check_pattern(
                "^(?:(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\d\\w]+)?)$",
    ...
    neighbor_router_id: Annotated[
        ...
        json_schema_extra={"is_config": False}, description="OSPF neighbor Router ID.", alias="neighbor-router-id"
    )
    ospf_adj_status: OspfAdjStatusEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="OSPF adjacency status.",
        default=None,
        alias="ospf-adj-status",
    )
...
class OspfInterfaceItem(YangBaseModel):
    ...
    ospf_if_routing: OspfIfRoutingEnum | None = Field(
        ...
        default=OspfIfRoutingEnum.ACTIVE,
    ...
    ospf_host_address: (
        ...
        json_schema_extra={"is_config": True},
        description="host IP address for p2p unnumbered interface.",
        default=None,
        alias="ospf-host-address",
    )
    ospf_adjacency: RestconfList[OspfAdjacencyItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="attributes of OSPF adjacency.",
        default=None,
        alias="ospf-adjacency",
    )
...
class Ospf(YangBaseModel):
    ...
    ] = Field(json_schema_extra={"is_config": True}, description="OSPF Router ID.", alias="router-id")
    description: str | None = Field(
        json_schema_extra={"is_config": True},
...
class BgpNeighborTimers(YangBaseModel):
    ...
    connect_retry: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
    ...
    hold_time: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
    ...
    keepalive_interval: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
    ...
    minimum_advertisement_interval: Decimal64 | None = Field(
        json_schema_extra={"is_config": True},
        description="Minimum time which must elapse between subsequent UPDATE\nmessages relating to a common set of NLRI being transmitted\nto a peer. This timer is referred to as\nMinRouteAdvertisementIntervalTimer by RFC 4721 and serves to\nreduce the number of UPDATE messages transmitted when a\nparticular set of NLRI exhibit instability.",
        ge=0,
        le=600,
        default=30,
        alias="minimum-advertisement-interval",
    )
    negotiated_hold_time: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
...
class BgpNeighborItem(YangBaseModel):
    ...
    peer_type: PeerTypeEnum | None = Field(
        json_schema_extra={"is_config": False},
    ...
    established_transitions: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        ...
        le=18446744073709551615,
        default=None,
        alias="established-transitions",
    )
    supported_capabilities: RestconfList[str] | None = Field(
        json_schema_extra={"is_config": False},
        description="BGP capabilities negotiated as supported with the peer",
        default=None,
        alias="supported-capabilities",
    )
    bgp_neighbor_timers: BgpNeighborTimers | None = Field(
        json_schema_extra={"is_config": True},
        description="Timers related to a BGP neighbor",
        default=None,
        alias="bgp-neighbor-timers",
    )
    bgp_neighbor_transport: BgpNeighborTransport | None = Field(
        json_schema_extra={"is_config": True},
        description="Transport session parameters for the BGP neighbor",
        default=None,
        alias="bgp-neighbor-transport",
    )
...
class RoutingProtocolItem(YangBaseModel):
    ...
    static_route: RestconfList[StaticRouteItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="A list of static routes.\n\nCondition (when): ../rtp-type = 'static'",
        default=None,
        alias="static-route",
    )
    ospf: Ospf | None = Field(
        json_schema_extra={"is_config": True},
        description="OSPF protocol.\n\nCondition (when): ../rtp-type = 'ospfv2'",
        default=None,
    )
    bgp: Bgp | None = Field(
        json_schema_extra={"is_config": True},
        description="Top-level configuration for the BGP router\n\nCondition (when): ../rtp-type = 'ebgp'",
        default=None,
    )
...
class RibItem(YangBaseModel):
    ...
    address_family: AddressFamilyEnum_1 = Field(
        json_schema_extra={"is_config": False}, description="Address family.", alias="address-family"
    )
    default_rib: bool | None = Field(
        json_schema_extra={"is_config": False},
    ...
    rib_description: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Textual description of the RIB.",
        min_length=0,
        max_length=128,
        default=None,
        alias="rib-description",
    )
    route: RestconfList[RouteItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="A list of static routes.\n\nCondition (when): (../address-family = 'ipv6') or (../address-family = 'ipv4')",
        default=None,
    )
    hmo_route: RestconfList[HmoRouteItem] | None = Field(
        json_schema_extra={"is_config": False},
...
class NeighborItem(YangBaseModel):
    ...
    link_layer_address: (
        ...
        default=None,
        alias="link-layer-address",
    )
    origin: OriginEnum_1 | None = Field(
        json_schema_extra={"is_config": True}, description="The origin of this neighbor entry.", default=None
    )
    outgoing_interface: str | None = Field(
        json_schema_extra={"is_config": True},
...
class NeighborsItem(YangBaseModel):
    ...
    address_family: str = Field(
        json_schema_extra={"is_config": True}, description="The address-family of the neighbor.", alias="address-family"
    )
    neighbor: RestconfList[NeighborItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class Routing(YangBaseModel):
    ...
    routing_protocol: RestconfList[RoutingProtocolItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Routing protocol instance.",
        default=None,
        alias="routing-protocol",
    )
    rib: RestconfList[RibItem] = Field(
        json_schema_extra={"is_config": False},
...
class PppProfileItem(YangBaseModel):
    ...
    ppp_fcs_length: PppFcsLengthEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Specifies whether the frame check sequence is a 16-bit or 32-bit value.",
        default=PppFcsLengthEnum._16,
        alias="ppp-fcs-length",
    )
    ppp_mru: int | None = Field(
        json_schema_extra={"is_config": True},
...
class Profiles(YangBaseModel):
    ...
    ppp_profile: RestconfList[PppProfileItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Profile for the point-to-point interface.",
        default=None,
        alias="ppp-profile",
    )
    ospf_link_profile: RestconfList[OspfLinkProfileItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Profile for the OSPF protocol link.",
        default=None,
        alias="ospf-link-profile",
    )
...
class PreShared(YangBaseModel):
    ...
    secret: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:([0-9a-fA-F]{2}(:[0-9a-fA-F]{2})*)?)$", v))] = (
        Field(json_schema_extra={"is_config": True}, description="Pre-shared secret value.")
    )
...
class PeerAuthentication(YangBaseModel):
    ...
    auth_method: AuthMethodEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Type of authentication method.",
        default=AuthMethodEnum.PRE_SHARED,
        alias="auth-method",
    )
    pre_shared: PreShared | None = Field(
        json_schema_extra={"is_config": True},
        description="Shared secret value for PSK.\n\nCondition (when): ../auth-method = 'pre-shared'",
        default=None,
        alias="pre-shared",
    )
...
class PadEntryItem(YangBaseModel):
    ...
    name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_/]*)$", v))] = Field(
        json_schema_extra={"is_config": True},
        description="PAD unique name to identify this\nentry.",
        min_length=1,
        max_length=128,
    )
    peer_authentication: PeerAuthentication | None = Field(
        json_schema_extra={"is_config": True},
        description="This container allows the Security\nController to configure the\nauthentication method (pre-shared key,\neap, digitial-signature, null) that\nwill use a particular peer and the\ncredentials, which will depend on the\nselected authentication method.",
        default=None,
        alias="peer-authentication",
    )
    # Choice: identity
    # Case: ipv4-address
    ipv4_address: (
...
class Pad(YangBaseModel):
    ...
    pad_entry: RestconfList[PadEntryItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class TrafficSelector(YangBaseModel):
    ...
    local_subnet: str = Field(
        json_schema_extra={"is_config": True}, description="Local IP address subnet.", alias="local-subnet"
    )
    remote_subnet: str = Field(
        json_schema_extra={"is_config": True}, description="Remote IP address subnet.", alias="remote-subnet"
    )
    inner_protocol: int | str | None = Field(
        json_schema_extra={"is_config": True},
        description="Inner Protocol that is going to be\nprotected with IPsec.",
        default="any",
        alias="inner-protocol",
    )
...
class EspAlgorithms(YangBaseModel):
    ...
    integrity: RestconfList[IntegrityAlgorithmTypeEnum] = Field(
        json_schema_extra={"is_config": True},
    ...
    encryption: RestconfList[EncryptionAlgorithmTypeEnum] = Field(
        json_schema_extra={"is_config": True}, description="Configuration of ESP encryption algorithms."
    )
...
class IpsecSaCfg(YangBaseModel):
    ...
    mode: ModeEnum | None = Field(
        ...
        default=ModeEnum.TRANSPORT,
    )
    protocol_parameters: ProtocolParametersEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Security protocol of the IPsec SA:\nOnly ESP is supported but it could be\nextended in the future.",
        default=ProtocolParametersEnum.ESP,
        alias="protocol-parameters",
    )
    esp_algorithms: EspAlgorithms | None = Field(
        json_schema_extra={"is_config": True},
        description="Configuration of Encapsulating\nSecurity Payload (ESP) parameters and\nalgorithms.\n\nCondition (when): ../protocol-parameters = 'esp'",
        default=None,
        alias="esp-algorithms",
    )
...
class ProcessingInfo(YangBaseModel):
    ...
    ipsec_sa_cfg: IpsecSaCfg | None = Field(
        json_schema_extra={"is_config": True},
...
class IpsecPolicyConfig(YangBaseModel):
    ...
    traffic_selector: TrafficSelector | None = Field(
        json_schema_extra={"is_config": True},
        description="Packets are selected for\nprocessing actions based on the IP and inner\nprotocol header information, selectors,\nmatched against entries in the SPD.",
        default=None,
        alias="traffic-selector",
    )
    processing_info: ProcessingInfo | None = Field(
        json_schema_extra={"is_config": True},
        description="SPD processing. If the required processing\naction is protect, it contains the required\ninformation to process the packet.",
        default=None,
        alias="processing-info",
    )
...
class SpdEntryItem(YangBaseModel):
    ...
    spd_entry_name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_/]*)$", v))] = (
        Field(
            json_schema_extra={"is_config": True},
            description="SPD entry unique name to identify\nthe IPsec policy.",
            min_length=1,
            max_length=128,
            alias="spd-entry-name",
        )
    )
    admin_status: AdminStatusEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    ipsec_policy_config: IpsecPolicyConfig | None = Field(
        json_schema_extra={"is_config": True},
        description="This container carries the\nconfiguration of a IPsec policy.",
        default=None,
        alias="ipsec-policy-config",
    )
...
class Spd(YangBaseModel):
    ...
    spd_entry: RestconfList[SpdEntryItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class ChildSaInfo(YangBaseModel):
    ...
    pfs_groups: RestconfList[Annotated[int, Field(ge=14), Field(le=21)]] = Field(
        json_schema_extra={"is_config": True}, description="perfect forward secrecy group numbers.", alias="pfs-groups"
    )
    child_sa_lifetime: ChildSaLifetime | None = Field(
        json_schema_extra={"is_config": True},
        description="IPsec SA lifetime soft.",
        default=None,
        alias="child-sa-lifetime",
    )
...
class IkeState(YangBaseModel):
    ...
    initiator: bool | None = Field(
        json_schema_extra={"is_config": False},
        description="It is acting as initiator for this\nconnection.",
        default=None,
    )
    initiator_ikesa_spi: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Initiator's IKE SA SPI.",
        default=None,
        alias="initiator-ikesa-spi",
    )
    responder_ikesa_spi: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Responder's IKE SA SPI.",
        default=None,
        alias="responder-ikesa-spi",
    )
    established: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
    ...
    current_rekey_time: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Seconds before IKE SA must be rekeyed.",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="current-rekey-time",
    )
    current_reauth_time: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Seconds before IKE SA must be\nre-authenticated.",
        ge=0,
        le=18446744073709551615,
        default=None,
        alias="current-reauth-time",
    )
...
class ConnEntryItem(YangBaseModel):
    ...
    ike_version: IkeVersionEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="IKE version. Only version 2 is supported\nso far.",
        default=IkeVersionEnum.IKEV2,
        alias="ike-version",
    )
    admin_status: AdminStatusEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    ike_sa_lifetime: IkeSaLifetime | None = Field(
        json_schema_extra={"is_config": True},
        description="IKE SA lifetime soft. Two lifetime values\ncan be configured: either rekey time of the\nIKE SA or reauth time of the IKE SA. When\nthe rekey lifetime expires a rekey of the\nIKE SA starts. When reauth lifetime\nexpires a IKE SA reauthentication starts.",
        default=None,
        alias="ike-sa-lifetime",
    )
    authalg: RestconfList[IntegrityAlgorithmTypeEnum] = Field(
        json_schema_extra={"is_config": True}, description="Authentication algorithm for establishing the IKE SA."
    )
    encalg: RestconfList[EncryptionAlgorithmTypeEnum] = Field(
        json_schema_extra={"is_config": True}, description="Encryption algorithm for the IKE SAs."
    )
    dh_group: int | None = Field(
        json_schema_extra={"is_config": True},
    ...
    local_address: str = Field(
        json_schema_extra={"is_config": True}, description="local address.", alias="local-address"
    )
    local_pad_entry_ref: str = Field(
        json_schema_extra={"is_config": True},
        ...
        alias="local-pad-entry-ref",
    )
    remote_address: str = Field(
        json_schema_extra={"is_config": True}, description="remote address.", alias="remote-address"
    )
    remote_pad_entry_ref: str = Field(
        json_schema_extra={"is_config": True},
        description="Remote peer authentication information.\nThis node points to a specific entry in\nthe PAD where the authorization\ninformation about this particular\nremote peer is stored. It MUST match a\npad-entry-name.",
        alias="remote-pad-entry-ref",
    )
    spd: Spd | None = Field(
        json_schema_extra={"is_config": True},
        description="Configuration of the Security Policy\nDatabase (SPD). This main information is\nplaced in the grouping\nipsec-policy-grouping.",
        default=None,
    )
    child_sa_info: ChildSaInfo | None = Field(
        json_schema_extra={"is_config": True},
        description="Specific information for IPsec SAs\nSAs. It includes PFS group and IPsec SAs\nrekey lifetimes.",
        default=None,
        alias="child-sa-info",
    )
    ike_state: IkeState | None = Field(
        json_schema_extra={"is_config": False},
...
class Ipsec(YangBaseModel):
    ...
    pad: Pad | None = Field(
        json_schema_extra={"is_config": True},
        description="Configuration of Peer Authorization Database\n(PAD). The PAD contains information about IKE\npeer (local and remote).",
        default=None,
    )
    conn_entry: RestconfList[ConnEntryItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class AclIpv4(YangBaseModel):
    ...
    source_ipv4_network: (
        ...
        default=None,
        alias="source-ipv4-network",
    )
    protocol: int | None = Field(
        json_schema_extra={"is_config": True},
...
class AclSnmpcommunity(YangBaseModel):
    ...
    community: (
        ...
        json_schema_extra={"is_config": True},
        description="String representing a ACL SNMP community string.",
        min_length=1,
        max_length=128,
        default=None,
    )
...
class Matches(YangBaseModel):
    ...
    acl_ipv4: AclIpv4 | None = Field(
        json_schema_extra={"is_config": True},
        description="Rule set that matches IPv4 headers.\n\nCondition (when): ../../../acl-type = 'ipv4-acl-type'",
        default=None,
        alias="acl-ipv4",
    )
    acl_ipv6: AclIpv6 | None = Field(
        json_schema_extra={"is_config": True},
        description="Rule set that matches IPv6 headers.\n\nCondition (when): ../../../acl-type = 'ipv6-acl-type'",
        default=None,
        alias="acl-ipv6",
    )
    acl_tcp: AclTcp | None = Field(
        json_schema_extra={"is_config": True},
        description="Rule set that matches TCP headers.",
        default=None,
        alias="acl-tcp",
    )
    acl_udp: AclUdp | None = Field(
        json_schema_extra={"is_config": True},
        description="Rule set that matches UDP headers.",
        default=None,
        alias="acl-udp",
    )
    acl_snmpcommunity: AclSnmpcommunity | None = Field(
        json_schema_extra={"is_config": True},
        description="Rule set that matches SnmpCommunity headers.",
        default=None,
        alias="acl-snmpcommunity",
    )
...
class AceItem(YangBaseModel):
    ...
    matches: Matches | None = Field(
        json_schema_extra={"is_config": True},
        description="The rules in this set determine what fields will be\nmatched upon before any action is taken on them.\nThe rules are selected based on the feature set\ndefined by the server and the acl-type defined.\nIf no matches are defined in a particular container,\nthen any packet will match that container.  If no\nmatches are specified at all in an ACE, then any\npacket will match the ACE.",
        default=None,
    )
    forwarding_action: ForwardingActionEnum = Field(
        json_schema_extra={"is_config": True},
        description="Specifies the forwarding action per ace entry.",
        alias="forwarding-action",
    )
...
class AclItem(YangBaseModel):
    ...
    name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = Field(
        json_schema_extra={"is_config": True}, description="The name of the access list.", min_length=1, max_length=128
    )
    acl_type: AclTypeEnum = Field(
        json_schema_extra={"is_config": True},
    ...
    ace: RestconfList[AceItem] | None = Field(
        json_schema_extra={"is_config": True}, description="List of ACEs.", default=None
    )
...
class AclLocalServiceItem(YangBaseModel):
    ...
    acl_set: RestconfList[AclSetItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class AclAttachmentPoints(YangBaseModel):
    ...
    acl_local_service: RestconfList[AclLocalServiceItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="The ACL attachment point of all the local network services.",
        default=None,
        alias="acl-local-service",
    )
...
class Dns(YangBaseModel):
    ...
    search: (
        Annotated[
            str, AfterValidator(lambda v: check_pattern("^(?:\\s*(([A-Za-z0-9_\\-]*\\.)+[A-Za-z0-9_\\-]*\\s*)*)$", v))
        ]
        | None
    ) = Field(
        json_schema_extra={"is_config": True},
        description="A list of DNS-search-suffix names can be provided. The separator is space.\nEach domain name should contain at least a single dot.\nTo clear value, set to empty string.",
        min_length=0,
        max_length=128,
        default=None,
    )
...
class Networking(YangBaseModel):
    ...
    source_address_select_mode: SourceAddressSelectModeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Select the source address for route next-hop entry.",
        default=SourceAddressSelectModeEnum.LINK_PREFER,
        alias="source-address-select-mode",
    )
    reserved_subnet: (
        Annotated[
            str,
    ...
    routing: Routing | None = Field(
        json_schema_extra={"is_config": True}, description="Container of routing protocols and ribs.", default=None
    )
    profiles: Profiles | None = Field(
        json_schema_extra={"is_config": True},
        description="Container of all the profiles used by networking, e.g. ppp-profile, ospf-if-profile.",
        default=None,
    )
    ipsec: Ipsec | None = Field(
        json_schema_extra={"is_config": True},
        description="IPsec configuration. It includes PAD parameters,\nIKE and Ipsec connections information and state data.",
        default=None,
    )
    ...
    acl_attachment_points: AclAttachmentPoints | None = Field(
        json_schema_extra={"is_config": True},
        description="Enclosing container for the list of\nattachment points on which ACLs are set.",
        default=None,
        alias="acl-attachment-points",
    )
    dns: Dns | None = Field(
...
class AuthorizedKeyItem(YangBaseModel):
    ...
    name: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\./]*)$", v))] = Field(
        json_schema_extra={"is_config": True}, description="name of authorized key.", min_length=1, max_length=64
    )
...
class UserItem(YangBaseModel):
    ...
    password_encrypt_method: PasswordEncryptMethodEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The password encrypt method of the user.",
        default=PasswordEncryptMethodEnum.AES,
        alias="password-encrypt-method",
    )
    authorized_key: RestconfList[AuthorizedKeyItem] | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="authorized-key"
    )
    user_class: UserClassEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The access class for the user.",
        default=UserClassEnum.SUPERVISION,
        alias="user-class",
    )
    max_invalid_login: int | None = Field(
        json_schema_extra={"is_config": True},
        description="This attribute is the maximum number of consecutive and invalid login attempts\nbefore an account is suspended (lockedout).\n\nCondition (when): ../user-aaa-type = 'local'",
        ge=0,
        le=9,
        default=3,
    ...
    previous_passwords: RestconfList[str] | None = Field(
        json_schema_extra={"is_config": False},
        description="Hash of previous passwords.",
        min_length=0,
        max_length=255,
        default=None,
        alias="previous-passwords",
    )
    user_admin_status: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The attribute allows administrators to modify the user administration status.",
        default=EnableSwitchEnum.ENABLED,
        alias="user-admin-status",
    )
    ...
    snmpv3: Snmpv3 | None = Field(
        json_schema_extra={"is_config": True}, description="SNMPv3 configuration for user", default=None
    )
...
class CliConfig(YangBaseModel):
    ...
    max_history_size: int | None = Field(
        ...
        ge=0,
        default=500,
        alias="max-history-size",
    )
    interactive_mode: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
    ...
    commit_mode: GainRangeControlEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Determines if the configuration changes shall be manually committed or automatically committed.\nThis setting is effective or the current CLI session only.",
        default=GainRangeControlEnum.AUTO,
        alias="commit-mode",
    )
...
class SessionItem(YangBaseModel):
    ...
    session_id: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[0-9A-Fa-f.:]*)$", v))] = Field(
        json_schema_extra={"is_config": True},
    ...
    session_user: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Points to a user instance.\n\nCondition (when): ../session-mode = 'server'",
        default=None,
        alias="session-user",
    )
    session_type: SessionTypeEnum = Field(
        json_schema_extra={"is_config": False}, description="Session type.", alias="session-type"
    )
    session_mode: SessionModeEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="the device role in session connection",
        default=SessionModeEnum.SERVER,
        alias="session-mode",
    )
    session_protocol: SessionProtocolEnum = Field(
        json_schema_extra={"is_config": False},
    ...
    cli_config: CliConfig | None = Field(
        json_schema_extra={"is_config": True},
        description="Condition (when): ../session-type = 'cli'",
        default=None,
        alias="cli-config",
    )
...
class AaaServerItem(YangBaseModel):
    ...
    server_ip: str = Field(
        json_schema_extra={"is_config": True}, description="The IP address of AAA server.", alias="server-ip"
    )
    server_port: int | None = Field(
        json_schema_extra={"is_config": True},
        description="AAA server port number.\n\nCondition (when): ../protocol-supported = 'TACACSPLUS'",
        ge=0,
        le=65535,
        default=49,
        alias="server-port",
...
class KeySyncSessionItem(YangBaseModel):
    ...
    remote_ip: Annotated[
        ...
        json_schema_extra={"is_config": True}, description="The IP address of remote session server.", alias="remote-ip"
    )
    remote_port: int | None = Field(
        json_schema_extra={"is_config": True},
    ...
    source_address_from: str | None = Field(
        json_schema_extra={"is_config": True},
        description="specifies the interface of the source IP address of the outgoing packets.\n\nCondition (when): ../key-sync-session-type = 'manual'",
        default="auto",
        alias="source-address-from",
    )
    connected_time: (
        Annotated[
            str,
        ...
        description="The timestamp the user has created this session.",
        default=None,
        alias="connected-time",
    )
    key_sync_session_type: CdCompensationModeEnum | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=CdCompensationModeEnum.MANUAL,
        alias="key-sync-session-type",
    )
...
class PskMapItem(YangBaseModel):
    ...
    key: (
        ...
        json_schema_extra={"is_config": True}, description="The key associated with the PSK identity", default=None
    )
    ...
    psk_status: PskStatusEnum | None = Field(
        json_schema_extra={"is_config": False},
    ...
    effective_timestamp: (
        ...
        default=None,
        alias="effective-timestamp",
    )
    hmo_psk_update: int | None = Field(
        json_schema_extra={"is_config": True},
        description="hmo for psk-update software.",
        ge=0,
        default=0,
        alias="hmo-psk-update",
    )
    ne_restart_cnt: int | None = Field(
        json_schema_extra={"is_config": True},
        description="hmo for ne restart count during psk-update.",
        ge=0,
        default=0,
        alias="ne-restart-cnt",
    )
    candidate_key: (
        Annotated[str, AfterValidator(lambda v: check_pattern("^(?:([0-9a-fA-F]{2}(:[0-9a-fA-F]{2})*)?)$", v))] | None
    ) = Field(
        json_schema_extra={"is_config": True},
        description="The candidate key associated with the PSK identity",
        default=None,
        alias="candidate-key",
    )
...
class PskMaps(YangBaseModel):
    ...
    psk_map: RestconfList[PskMapItem] | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="psk-map"
    )
...
class CertificateChainItem(YangBaseModel):
    ...
    certificate_chain_level: Annotated[
        str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\.]*)$", v))
    ] = Field(
        json_schema_extra={"is_config": False},
        ...
        min_length=1,
        max_length=128,
        alias="certificate-chain-level",
    )
    version: VersionEnum | None = Field(
        json_schema_extra={"is_config": False}, description="version of the certificate.", default=VersionEnum.X509V1
    )
    serial_number: str | None = Field(
        json_schema_extra={"is_config": False},
...
class CertificateItem(YangBaseModel):
    ...
    certificate_content: str | None = Field(
        json_schema_extra={"is_config": False},
        description="certificate.",
        min_length=0,
        max_length=50000,
        default=None,
        alias="certificate-content",
    )
    version: VersionEnum | None = Field(
        json_schema_extra={"is_config": False}, description="version of the certificate.", default=VersionEnum.X509V1
    )
    ...
    certificate_chain: RestconfList[CertificateChainItem] | None = Field(
        json_schema_extra={"is_config": False},
...
class KeyItem(YangBaseModel):
    ...
    algorithm_identifier: AlgorithmIdentifierEnum = Field(
        json_schema_extra={"is_config": True},
    ...
    certificate: RestconfList[CertificateItem] | None = Field(
        json_schema_extra={"is_config": False}, description="A certificate for this private key.", default=None
    )
...
class TrustedCertificateItem(YangBaseModel):
    ...
    trusted_certificate_name: Annotated[
        str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\.]*)$", v))
    ] = Field(
        json_schema_extra={"is_config": False},
        ...
        min_length=1,
        max_length=128,
        alias="trusted-certificate-name",
    )
    certificate_content: str | None = Field(
        json_schema_extra={"is_config": False},
        description="certificate.",
...
class TrustedCertificateGroupItem(YangBaseModel):
    ...
    trusted_certificate_group_name: Annotated[
        str, AfterValidator(lambda v: check_pattern("^(?:[A-Za-z0-9][a-zA-Z0-9\\-_:\\.]*)$", v))
    ] = Field(
        json_schema_extra={"is_config": False},
        ...
        min_length=1,
        max_length=128,
        alias="trusted-certificate-group-name",
    )
...
class Keystore(YangBaseModel):
    ...
    key: RestconfList[KeyItem] | None = Field(
        json_schema_extra={"is_config": True}, description="A key maintained by the keystore.", default=None
    )
    trusted_certificate_group: RestconfList[TrustedCertificateGroupItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="A list of trusted certificates.\nThese certificates can be used by a server to authenticate clients, or by clients to authenticate servers.\nThe certificates may be endpoint specific or for certificate authorities, to authenticate many clients at once.\nEach list of certificates SHOULD be specific to a purpose, as the list as a whole may be referenced by other modules.\nFor instance, a NETCONF server model might point to a list of certificates to use when authenticating client certificates.",
        default=None,
        alias="trusted-certificate-group",
    )
...
class Security(YangBaseModel):
    ...
    ssh_public_key: RestconfList[str] | None = Field(
        json_schema_extra={"is_config": False},
        description="The system's public key for use with SSH or SFTP.",
        min_length=0,
        max_length=3000,
        default=None,
        alias="ssh-public-key",
    )
    ssh_private_key: RestconfList[str] | None = Field(
        json_schema_extra={"is_config": False},
        description="The system's private key for use with SSH or SFTP.",
        min_length=0,
        max_length=8000,
        default=None,
        alias="ssh-private-key",
    )
    ssh_public_key_fingerprint: RestconfList[str] | None = Field(
        json_schema_extra={"is_config": False},
        description="The fingerprint of the system's public key.",
        min_length=0,
        max_length=256,
        default=None,
        alias="ssh-public-key-fingerprint",
    )
    ssh_sha1_support: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Defines if ssh-sha1 is enabled for SSH. This applies to sha-1 hash and HMAC.",
        default=EnableSwitchEnum.ENABLED,
        alias="ssh-sha1-support",
    )
    ...
    strict_password_check: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Defines whether system password follow strict checking",
        default=EnableSwitchEnum.ENABLED,
        alias="strict-password-check",
    )
    grpc_local_certificate: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Certificate for gRPC dial-in server and dial-out client.",
        default="none",
        alias="grpc-local-certificate",
    )
    grpc_dial_out_trusted_certgrp: str | None = Field(
        json_schema_extra={"is_config": True},
        description="trusted certificate group for gRPC dial-out client.",
        default="none",
        alias="grpc-dial-out-trusted-certgrp",
    )
    grpc_dial_in_trusted_certgrp: str | None = Field(
        json_schema_extra={"is_config": True},
        description="trusted certificate group for gRPC dial-in server.",
        default="none",
        alias="grpc-dial-in-trusted-certgrp",
    )
    grpc_dial_out_authentication: GrpcDialOutAuthenticationEnum | None = Field(
        json_schema_extra={"is_config": True},
        default=GrpcDialOutAuthenticationEnum.NONE,
        alias="grpc-dial-out-authentication",
    )
    grpc_dial_in_authentication: GrpcDialOutAuthenticationEnum | None = Field(
        json_schema_extra={"is_config": True},
        default=GrpcDialOutAuthenticationEnum.NONE,
        alias="grpc-dial-in-authentication",
    )
    https_local_certificate: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Certificate for both WebGUI https server and RESTCONF https server.",
        default="none",
        alias="https-local-certificate",
    )
    restconf_https_trusted_certgrp: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Certificate group for RESTCONF https server.",
        default="none",
        alias="restconf-https-trusted-certgrp",
    )
    restconf_https_authentication: RestconfHttpsAuthenticationEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Update TLS auth for RESTCONF\n\nCondition (when): /ne/system/restconf/rest-https-support = 'enabled'",
        default=RestconfHttpsAuthenticationEnum.TLS_UNI_AUTH,
        alias="restconf-https-authentication",
    )
    ...
    aaa_server: RestconfList[AaaServerItem] | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="aaa-server"
    )
    key_sync_session: RestconfList[KeySyncSessionItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="TLS session to synchronize ODU encryption key.",
        default=None,
        alias="key-sync-session",
    )
    psk_maps: PskMaps | None = Field(
        json_schema_extra={"is_config": True},
        description="During authentication, PSK identity is used to\nlook up an entry in the psk-map list. If such\nan entry is found, and the pre-shared keys match,\nthen the client is authenticated. If the server\ncannot find an entry in the psk-map list, or if\nthe pre-shared keys do not match, then the server\nterminates the connection.",
        default=None,
        alias="psk-maps",
    )
    keystore: Keystore | None = Field(
        json_schema_extra={"is_config": True},
        description="The keystore contains both active material (e.g., private keys and passwords) and passive material (e.g., trust anchors).\nThe active material can be used to support either a server (e.g.,a TLS/SSH server's private keys) or a client (a private key used for TLS/SSH client-certificate based authentication, or a password used for SSH/HTTP-client authentication).\nThe passive material can be used to support either a server (e.g., client certificates to trust) or clients (e.g., server certificates to trust).",
        default=None,
    )
...
class DatabaseItem(YangBaseModel):
    ...
    database_id: int = Field(
        json_schema_extra={"is_config": False},
        description="database identifier which is uniquely identify specific database.",
        ge=1,
        le=10,
        alias="database-id",
    )
    database_state: SwloadStateEnum | None = Field(
        json_schema_extra={"is_config": False},
    ...
    backup_time: (
        ...
        json_schema_extra={"is_config": False},
        description="Indicates the database last backup time.",
        default="",
        alias="backup-time",
    )
...
class FwVersionMapItem(YangBaseModel):
    ...
    device_name: str = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the name of the device.",
        min_length=0,
        max_length=64,
        alias="device-name",
    )
    device_fw_version: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the version of the firmware.",
        min_length=0,
        max_length=64,
        default=None,
        alias="device-fw-version",
    )
...
class SoftwareloadItem(YangBaseModel):
    ...
    swload_id: int = Field(
        json_schema_extra={"is_config": False},
        description="software load identifier which is uniquely identify specific software load.",
        ge=1,
        le=10,
        alias="swload-id",
    )
    swload_state: SwloadStateEnum | None = Field(
        json_schema_extra={"is_config": False},
    ...
    swload_version: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the software version of the software load.",
        min_length=0,
        max_length=20,
        default=None,
    ...
    swload_vendor: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Vendor information of the software load.",
        min_length=0,
        max_length=32,
        default=None,
        alias="swload-vendor",
    ...
    swload_product: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the network element family this software belongs to.",
        min_length=0,
        max_length=32,
        default=None,
    ...
    swload_label: str | None = Field(
        json_schema_extra={"is_config": False},
        description="The label of the software load including summary information.",
        min_length=0,
        max_length=1024,
        default=None,
        alias="swload-label",
...
class CurrentFwVersionItem(YangBaseModel):
    ...
    equipment_entity: str = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the entity of the equipment carrying the device.",
        alias="equipment-entity",
    )
    fw_equipment_type: EquipmentTypeEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the type of the equipment carrying the device.",
        default=None,
        alias="fw-equipment-type",
    )
    device_name: str = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the name of the device.",
    ...
    fw_state: FwStateEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates firmware state of the device.\nCurrent: indicates the loaded firmware is the version of current software load.\nNot-current: indicates the loaded firmware is not the version of current software load.",
        default=FwStateEnum.NOT_AVAILABLE,
        alias="fw-state",
    )
    system_fw_version: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the version of the firmware in system appication.",
        min_length=0,
        max_length=64,
        default=None,
        alias="system-fw-version",
    )
...
class RollbackPointItem(YangBaseModel):
    ...
    creation_trigger: (
        ...
        max_length=32,
        default=None,
        alias="creation-trigger",
    )
    type: TypeEnum | None = Field(
        json_schema_extra={"is_config": False}, description="The type of the rollback-point", default=TypeEnum.NORMAL
    )
    description: str | None = Field(
        json_schema_extra={"is_config": True},
...
class SwManagement(YangBaseModel):
    ...
    softwareload: RestconfList[SoftwareloadItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="The list of the software loads in the system.",
        default=None,
    )
    current_fw_version: RestconfList[CurrentFwVersionItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="The firmware information of the upgradable devices included in the software load.",
        default=None,
        alias="current-fw-version",
    )
    ...
    rollback_point: RestconfList[RollbackPointItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents a rollback point stored in the system.\nA rollback point represents the system configuration of a specific point in time, that the user may create with the\n'create-rollback-point' command, visualize with the 'diff' command' and rollback to with the 'rollback' command.\nThe system is able to store up to 10 rollback-points, rolling over old instances as new ones are created.\nThe incremental IDs of 1..10 are automatically generated by the system whenever the rollback-point is created.\nRollback points can be deleted as any normal object.\nA special 'backup' rollback-point can also be created with ID 0; unlike normal rollback-points, this instance will\nbe kept even after activation with the 'rollback' RPC.",
        default=None,
        alias="rollback-point",
    )
...
class LogFacilityItem(YangBaseModel):
    ...
    log_selector_facility: LogSelectorFacilityEnum = Field(
        json_schema_extra={"is_config": True},
        description="The leaf uniquely identifies a syslog facility for forwarding.",
        alias="log-selector-facility",
    )
    log_selector_severity: LogSelectorSeverityEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The system log selected severity level for forwarding",
        default=LogSelectorSeverityEnum.DEBUG,
        alias="log-selector-severity",
    )
...
class LogForwardingSelector(YangBaseModel):
    ...
    log_facility: RestconfList[LogFacilityItem] | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="log-facility"
    )
...
class LogServerItem(YangBaseModel):
    ...
    log_server_name: str = Field(
        json_schema_extra={"is_config": True},
        description="The name for the endpoint to forwarding logs to.",
        min_length=1,
        max_length=64,
        alias="log-server-name",
    )
    log_server_ip_address: str = Field(
        json_schema_extra={"is_config": True},
        description="The leaf uniquely specifies the ipv4 address of the remote host.",
        alias="log-server-ip-address",
    )
    log_server_transport: LogServerTransportEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="It is the transport protocol used when forwarding logs.",
        default=LogServerTransportEnum.UDP,
        alias="log-server-transport",
    )
    log_server_port: int | None = Field(
        ...
        le=65535,
        default=514,
        alias="log-server-port",
    )
    log_forwarding_selector: LogForwardingSelector | None = Field(
        json_schema_extra={"is_config": True},
        description="This container describes the log selector parameters for syslog.",
        default=None,
        alias="log-forwarding-selector",
    )
    destination_facility_type: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Switching of the function destination-facility",
        default=EnableSwitchEnum.DISABLED,
        alias="destination-facility-type",
    )
    destination_facility: (
        Annotated[str, AfterValidator(lambda v: check_pattern("^(?:([0-9]|1[0-9]|2[0-3])?)$", v))] | None
    ) = Field(
        json_schema_extra={"is_config": True},
        description="This leaf specifies the facility used in messages delivered to the remote server.",
        default="23",
        alias="destination-facility",
    )
...
class SensorPathItem(YangBaseModel):
    ...
    index: str = Field(
        json_schema_extra={"is_config": True}, description="index for sensor-path", min_length=1, max_length=320
    )
...
class SensorPaths(YangBaseModel):
    ...
    sensor_path: RestconfList[SensorPathItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class SensorGroups(YangBaseModel):
    ...
    sensor_group: RestconfList[SensorGroupItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class Destinations(YangBaseModel):
    ...
    destination: RestconfList[DestinationItem] | None = Field(
        json_schema_extra={"is_config": True}, description="List of telemetry stream destinations", default=None
    )
...
class DestinationGroupItem(YangBaseModel):
    ...
    destinations: Destinations | None = Field(
        json_schema_extra={"is_config": True},
        description="The destination container lists the destination\ninformation such as IP address and port of the\ntelemetry messages from the network element.",
        default=None,
    )
...
class DestinationGroups(YangBaseModel):
    ...
    destination_group: RestconfList[DestinationGroupItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class SensorProfiles(YangBaseModel):
    ...
    sensor_profile: RestconfList[SensorProfileItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="List of telemetry sensor groups used\nin the subscription",
        default=None,
        alias="sensor-profile",
    )
...
class DestinationProfiles(YangBaseModel):
    ...
    destination_profile: RestconfList[DestinationProfileItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Identifier of the previously defined destination\ngroup",
        default=None,
        alias="destination-profile",
    )
...
class DialOutSubscriptionItem(YangBaseModel):
    ...
    start_streaming_time: (
        ...
        default="0000-01-01T00:00:00.000Z",
        alias="start-streaming-time",
    )
    streaming_data_model: StreamingDataModelEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The stream out data based on selected model",
        default=StreamingDataModelEnum.DEVICE_MODEL,
        alias="streaming-data-model",
    )
    ...
    subscription_id: Uint64 | None = Field(
        json_schema_extra={"is_config": False},
    ...
    sensor_profiles: SensorProfiles | None = Field(
        json_schema_extra={"is_config": True},
        description="A sensor profile is a set of sensor groups or\nindividual sensor paths which are associated with a\ntelemetry subscription. This is the source of the\ntelemetry data for the subscription to send to the\ndefined collectors.",
        default=None,
        alias="sensor-profiles",
    )
    destination_profiles: DestinationProfiles | None = Field(
        json_schema_extra={"is_config": True},
        description="A subscription may specify destination addresses.\nIf the subscription supplies destination addresses,\nthe network element will be the initiator of the\ntelemetry streaming, sending it to the destination(s)\nspecified.\nIf the destination set is omitted, the subscription\npreconfigures certain elements such as paths and\nsample intervals under a specified subscription ID.\nIn this case, the network element will NOT initiate an\noutbound connection for telemetry, but will wait for\nan inbound connection from a network management\nsystem.\nIt is expected that the network management system\nconnecting to the network element will reference\nthe preconfigured subscription ID when initiating\na subscription.",
        default=None,
        alias="destination-profiles",
    )
...
class Persistent(YangBaseModel):
    ...
    dial_out_subscription: RestconfList[DialOutSubscriptionItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="List of telemetry subscriptions. A telemetry\nsubscription consists of a set of collection\ndestinations, stream attributes, and associated paths to\nstate information in the model (sensor data)",
        default=None,
        alias="dial-out-subscription",
    )
...
class DialInSensorPathItem(YangBaseModel):
    ...
    path_state: PathState | None = Field(
        json_schema_extra={"is_config": False},
...
class DialInSensorPaths(YangBaseModel):
    ...
    dial_in_sensor_path: RestconfList[DialInSensorPathItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="List of paths in the model which together\ncomprise a sensor grouping. Filters for each path\nto exclude items are also provided.",
        default=None,
        alias="dial-in-sensor-path",
    )
...
class DialInSubscriptionItem(YangBaseModel):
    ...
    state_dial_in_subscription: StateDialInSubscription | None = Field(
        json_schema_extra={"is_config": False},
        description="State information relating to dynamic telemetry\nsubscriptions.",
        default=None,
        alias="state-dial-in-subscription",
    )
    dial_in_sensor_paths: DialInSensorPaths | None = Field(
        json_schema_extra={"is_config": False},
        description="Top level container to hold a set of sensor\npaths grouped together",
        default=None,
        alias="dial-in-sensor-paths",
    )
...
class Dynamic(YangBaseModel):
    ...
    dial_in_subscription: RestconfList[DialInSubscriptionItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="List representation of telemetry subscriptions that\nare configured via an inline RPC, otherwise known\nas dynamic telemetry subscriptions.",
        default=None,
        alias="dial-in-subscription",
    )
...
class Subscriptions(YangBaseModel):
    ...
    persistent: Persistent | None = Field(
        json_schema_extra={"is_config": True},
        description="This container holds information relating to persistent\ntelemetry subscriptions. A persistent telemetry\nsubscription is configued locally on the device through\nconfiguration, and is persistent across device restarts or\nother redundancy changes.",
        default=None,
    )
...
class TelemetrySystem(YangBaseModel):
    ...
    sensor_groups: SensorGroups | None = Field(
        json_schema_extra={"is_config": True},
        description="Top level container for sensor-groups.",
        default=None,
        alias="sensor-groups",
    )
    destination_groups: DestinationGroups | None = Field(
        json_schema_extra={"is_config": True},
        description="Top level container for destination group configuration\nand state.",
        default=None,
        alias="destination-groups",
    )
...
class FileManagement(YangBaseModel):
    ...
    telemetry_system: TelemetrySystem | None = Field(
        json_schema_extra={"is_config": True},
        description="Top level configuration and state for the\ndevice telemetry system.",
        default=None,
        alias="telemetry-system",
    )
...
class Lldp(YangBaseModel):
    ...
    msgTxHoldMultiplier: int | None = Field(
        json_schema_extra={"is_config": True},
...
class NtpAssociationStatus(YangBaseModel):
    ...
    ntp_association_refid: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Reference clock type or address for the peer.",
        min_length=0,
        max_length=16,
        default=None,
        alias="ntp-association-refid",
    )
    ntp_stratum: int | None = Field(
        json_schema_extra={"is_config": False},
    ...
    ntp_polling_interval: int | None = Field(
        json_schema_extra={"is_config": False},
...
class NtpAssociationItem(YangBaseModel):
    ...
    ntp_association_source: str = Field(
        json_schema_extra={"is_config": True},
        description="Indicates the ntp-association-source.",
        alias="ntp-association-source",
    )
    ntp_association_type: NtpAssociationTypeEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates the ntp association type.",
        default=NtpAssociationTypeEnum.NTP_SERVER,
        alias="ntp-association-type",
    )
    preferred_ntp_association: bool | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicates if this is preferred.",
        default=None,
        alias="preferred-ntp-association",
    )
    ntp_admin_state: OperStatusEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The administrative state specifies the permission to use or prohibition against using the resource.",
        default=OperStatusEnum.UP,
        alias="ntp-admin-state",
    )
    ntp_association_status: NtpAssociationStatus | None = Field(
        json_schema_extra={"is_config": False}, default=None, alias="ntp-association-status"
    )
...
class Ntp(YangBaseModel):
    ...
    current_time_source: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the current time source.",
        default="0.0.0.0",
        alias="current-time-source",
    )
    ntp_association: RestconfList[NtpAssociationItem] | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="ntp-association"
    )
...
class TimeManager(YangBaseModel):
    ...
    timezone: TimezoneEnum | None = Field(
        ...
        default=TimezoneEnum.GREENWICH_MEAN_TIME_DUBLIN_EDINBURGH_LISBON_LONDON_GMT,
    )
    current_time: (
        Annotated[
            str,
    ...
    up_time: str | None = Field(
        json_schema_extra={"is_config": False},
        description="Indicate how long the system has been running.",
        default=None,
        alias="up-time",
    )
    time_source_state: TimeSourceStateEnum = Field(
        json_schema_extra={"is_config": False},
        description="Indicates the state of the time source.",
        alias="time-source-state",
    )
    ntp: Ntp | None = Field(
        json_schema_extra={"is_config": True},
        description="NTP (Network Time Protocol) system configuration and state",
        default=None,
    )
...
class Ztc(YangBaseModel):
    ...
    ztc_enabled: bool | None = Field(
        json_schema_extra={"is_config": True},
        description="enable/disable Zero Touch commissioning.",
        default=True,
        alias="ztc-enabled",
    )
    ztc_status: ZtcStatusEnum | None = Field(
        json_schema_extra={"is_config": False},
        ...
        default=ZtcStatusEnum.READY,
        alias="ztc-status",
    )
    ztc_avail_status: str | None = Field(json_schema_extra={"is_config": False}, default=None, alias="ztc-avail-status")
    ztc_proxy: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The attribute will enable/disable the ztc proxy function for the subtending NEs.",
        default=EnableSwitchEnum.ENABLED,
        alias="ztc-proxy",
    )
    dhcp_server: (
        ...
        json_schema_extra={"is_config": True},
        description="The IPv4 address of the DHCP server for the DHCP relay agent when the ztc-proxy is enabled.",
        default=None,
        alias="dhcp-server",
    )
    ztc_if_name: str | None = Field(
        json_schema_extra={"is_config": False},
        description="The interface name ztc is working on.",
        default=None,
        alias="ztc-if-name",
    )
...
class SnmpTargetItem(YangBaseModel):
    ...
    snmpv3_user: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Indicate the snmpv3 user.\n\nCondition (when): ../snmp-version = 'v3'",
        default=None,
        alias="snmpv3-user",
    )
    ...
    target_ip: str = Field(
        json_schema_extra={"is_config": True}, description="IP address of the SNMP target", alias="target-ip"
    )
...
class Restconf(YangBaseModel):
    ...
    rest_http_support: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Defines if the HTTP port (8080) is enabled for RESTCONF",
        default=EnableSwitchEnum.DISABLED,
        alias="rest-http-support",
    )
    rest_https_support: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="Defines if the HTTPS port (8181) is enabled for RESTCONF",
        default=EnableSwitchEnum.ENABLED,
        alias="rest-https-support",
    )
    rest_session_timeout: int | None = Field(
        json_schema_extra={"is_config": True},
...
class Cli(YangBaseModel):
    ...
    enabled: bool | None = Field(
        json_schema_extra={"is_config": True},
        description="User configurable switch to enable or disable CLI access",
        default=True,
    )
    ...
    cli_script: RestconfList[CliScriptItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class Netconf(YangBaseModel):
    ...
    annotate_cli_name: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
...
class Webgui(YangBaseModel):
    ...
    enabled: bool | None = Field(
        json_schema_extra={"is_config": True},
        description="User configurable switch to enable or disable webgui access",
        default=True,
    )
...
class ModelSelection(YangBaseModel):
    ...
    openroadm: bool | None = Field(
        json_schema_extra={"is_config": True}, description="The openroadm support or not", default=False
    )
    openconfig: OpenconfigEnum | None = Field(
        json_schema_extra={"is_config": True}, description="The openconfig working mode", default=OpenconfigEnum.FALSE
    )
...
class DeleteFile(YangBaseModel):
    ...
    file_name: str | None = Field(
        json_schema_extra={"is_config": True}, min_length=0, max_length=255, default=None, alias="file-name"
    )
    result: ResultEnum | None = Field(json_schema_extra={"is_config": True}, default=None)
    result_msg: str | None = Field(
        json_schema_extra={"is_config": True}, min_length=0, max_length=255, default=None, alias="result-msg"
    )
...
class ShowFile(YangBaseModel):
    ...
    result: ResultEnum | None = Field(json_schema_extra={"is_config": True}, default=None)
    result_msg: str | None = Field(
        json_schema_extra={"is_config": True}, min_length=0, max_length=511, default=None, alias="result-msg"
    )
...
class FileTransfer(YangBaseModel):
    ...
    local_file_path: str | None = Field(
        json_schema_extra={"is_config": True}, min_length=0, max_length=255, default=None, alias="local-file-path"
    )
    remote_file_path: str | None = Field(
        json_schema_extra={"is_config": True}, min_length=0, max_length=255, default=None, alias="remote-file-path"
    )
    result: ResultEnum | None = Field(json_schema_extra={"is_config": True}, default=None)
    result_msg: str | None = Field(
        json_schema_extra={"is_config": True}, min_length=0, max_length=511, default=None, alias="result-msg"
    ...
    exe_result_msg: str | None = Field(
        json_schema_extra={"is_config": True}, min_length=0, max_length=511, default=None, alias="exe-result-msg"
    )
...
class MultishelfFileManagementItem(YangBaseModel):
    ...
    file_transfer: FileTransfer | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="file-transfer"
    )
...
class SwActivateNotification(YangBaseModel):
    ...
    activate_notification_type: ActivateNotificationTypeEnum = Field(
        json_schema_extra={"is_config": True}, description="Successful or Failed", alias="activate-notification-type"
    )
    status: StatusEnum = Field(json_schema_extra={"is_config": True}, description="Successful or Failed")
    status_message: str | None = Field(
        json_schema_extra={"is_config": True},
    ...
    activate_state: ActivateStateEnum | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="activate-state"
    )
    upgrade_result: UpgradeResultEnum | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="upgrade-result"
    )
...
class MultishelfSwManagementItem(YangBaseModel):
    ...
    shelf_id: int = Field(json_schema_extra={"is_config": True}, ge=1, alias="shelf-id")
    sw_stage_notification: SwStageNotification | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="sw-stage-notification"
    )
    sw_activate_notification: SwActivateNotification | None = Field(
        json_schema_extra={"is_config": True}, default=None, alias="sw-activate-notification"
    )
...
class MultishelfDiscoveryItem(YangBaseModel):
    ...
    shelf_status: ShelfStatusEnum | None = Field(
        json_schema_extra={"is_config": False}, default=None, alias="shelf-status"
    )
    shelf_id: int | None = Field(
        json_schema_extra={"is_config": False},
        description="Identifier of the shelf after assigned by the system.",
        ge=1,
        default=None,
        alias="shelf-id",
    )
    ...
    supplementary_information: str | None = Field(
        json_schema_extra={"is_config": False},
        description="supplementary infomation of the shelf",
        default=None,
...
class SystemSystem(YangBaseModel):
    ...
    factory_reset_button: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The attribute will enable/disable factory reset button function on the NE.",
        default=EnableSwitchEnum.ENABLED,
        alias="factory-reset-button",
    )
    auto_service_creation: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        ...
        default=EnableSwitchEnum.ENABLED,
        alias="auto-service-creation",
    )
    multi_shelf: EnableSwitchEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="The attribute will enable/disable multi-shelf function on the NE.",
        default=EnableSwitchEnum.DISABLED,
        alias="multi-shelf",
    )
    power_consumption: PowerConsumption | None = Field(
        json_schema_extra={"is_config": True},
        description="The shelf base power consumption",
        default=None,
    ...
    sw_management: SwManagement | None = Field(
        json_schema_extra={"is_config": True},
        description="The container includes management objects of software, for example, software load, database.",
        default=None,
        alias="sw-management",
    )
    file_management: FileManagement | None = Field(
        json_schema_extra={"is_config": True},
        description="Container includes management of log files, for example log-forwarding",
        default=None,
        alias="file-management",
    )
    lldp: Lldp | None = Field(
        json_schema_extra={"is_config": True}, description="Container for LLDP config and status.", default=None
    )
    ...
    console: Console | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the console ports available in the system",
        default=None,
    )
    ssh: Ssh | None = Field(
        json_schema_extra={"is_config": True},
        description="Represents the ssh server that allows Linux shell access to the user",
        default=None,
    )
    snmp: Snmp | None = Field(
        json_schema_extra={"is_config": True}, description="Container with SNMP related configurations", default=None
    )
    restconf: Restconf | None = Field(
        json_schema_extra={"is_config": True},
        description="RESTCONF related configurations.\n\nRESTCONF is a HTTP based protocol that provides an interface for accessing\nYANG data models.",
        default=None,
    )
    cli: Cli | None = Field(
        json_schema_extra={"is_config": True}, description="CLI related configurations", default=None
    )
    netconf: Netconf | None = Field(
        json_schema_extra={"is_config": True}, description="NETCONF related configurations", default=None
    )
    grpc: Grpc | None = Field(
        json_schema_extra={"is_config": True}, description="gRPC/gNMI related configurations", default=None
    )
    webgui: Webgui | None = Field(
        json_schema_extra={"is_config": True}, description="WebGUI related configurations", default=None
    )
    model_selection: ModelSelection | None = Field(
        json_schema_extra={"is_config": True},
        description="Configuration of enabled YANG models",
        default=None,
        alias="model-selection",
    )
    multishelf_file_management: RestconfList[MultishelfFileManagementItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="multishelf-file-management YANG models",
        default=None,
        alias="multishelf-file-management",
    )
    multishelf_sw_management: RestconfList[MultishelfSwManagementItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="multishelf-sw-management YANG models",
        default=None,
        alias="multishelf-sw-management",
    )
    multishelf_discovery: RestconfList[MultishelfDiscoveryItem] | None = Field(
        json_schema_extra={"is_config": False}, default=None, alias="multishelf-discovery"
    )
    capabilities: Capabilities | None = Field(
        json_schema_extra={"is_config": True}, description="System capabilities for each function", default=None
    )
...
class RstpBridgePortTableItem(YangBaseModel):
    ...
    priority: int | None = Field(
        json_schema_extra={"is_config": True}, description="The value of the priority field", ge=0, le=240, default=128
    )
    port_id: int | None = Field(
        json_schema_extra={"is_config": True}, description="Bridge port id", ge=0, default=0, alias="port-id"
    )
...
class RstpConfig(YangBaseModel):
    ...
    bridge_priority: int | None = Field(
        json_schema_extra={"is_config": True},
        description="Bridge Priority Value",
        ge=0,
        le=61440,
        default=32768,
        alias="bridge-priority",
    )
    shutdown: bool | None = Field(
        json_schema_extra={"is_config": True}, description="Bridge admin state", default=False
    )
    ...
    transmit_hold_count: int | None = Field(
        json_schema_extra={"is_config": True},
        description="Maximum BPDU transmission rate",
        ge=1,
        le=10,
        default=2,
        alias="transmit-hold-count",
    )
    rstp_bridge_port_table: RestconfList[RstpBridgePortTableItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="Table contains port-specific information for rstp config",
        default=None,
        alias="rstp-bridge-port-table",
    )
...
class RstpBridgeAttr(YangBaseModel):
    ...
    root_bridge_port: int | None = Field(
        json_schema_extra={"is_config": False},
        description="Port id of the root port",
        ge=0,
        default=None,
        alias="root-bridge-port",
    )
    root_path_cost: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The cost of the path to the root as\nseen from this bridge",
        ge=0,
        default=None,
        alias="root-path-cost",
    )
    root_bridge_priority: int | None = Field(
        json_schema_extra={"is_config": False},
        description="Root Bridge Priority Value",
        ge=0,
        default=None,
        alias="root-bridge-priority",
    )
    ...
    topo_change_count: int | None = Field(
        json_schema_extra={"is_config": False},
        description="The total number of topology changes",
        ge=0,
        default=None,
        alias="topo-change-count",
    )
    time_since_topo_change: int | None = Field(
        json_schema_extra={"is_config": False},
        description="Time since last topology changes occurred (in seconds)",
        ge=0,
        default=None,
        alias="time-since-topo-change",
    )
...
class RstpBridgePortStateTableItem(YangBaseModel):
    ...
    bridge_port_state: BridgePortStateEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="The port's current state",
        default=BridgePortStateEnum.UNKNOWN,
        alias="bridge-port-state",
    )
    bridge_port_role: BridgePortRoleEnum | None = Field(
        json_schema_extra={"is_config": False},
        description="The role payed by this port in the bridge",
        default=BridgePortRoleEnum.UNKNOWN,
        alias="bridge-port-role",
    )
    bridge_port_id: int | None = Field(
        json_schema_extra={"is_config": False},
        description="Unique port id of this port",
        ge=0,
        default=None,
        alias="bridge-port-id",
    )
    oper_edge_bridge_port: bool | None = Field(
        json_schema_extra={"is_config": False},
        description="The operational value of the Edge Port parameter",
        default=None,
        alias="oper-edge-bridge-port",
    )
    designated_bridge_port: int | None = Field(
        json_schema_extra={"is_config": False},
        description="Port id of the designated port",
        ge=0,
        default=None,
        alias="designated-bridge-port",
    )
    designated_bridgeid: str | None = Field(
        json_schema_extra={"is_config": False},
...
class RstpBridgePortStateAttr(YangBaseModel):
    ...
    rstp_bridge_port_state_table: RestconfList[RstpBridgePortStateTableItem] | None = Field(
        json_schema_extra={"is_config": False},
        description="This table contains port-specific information for rstp state attributes",
        default=None,
        alias="rstp-bridge-port-state-table",
    )
...
class RstpState(YangBaseModel):
    ...
    rstp_bridge_attr: RstpBridgeAttr | None = Field(
        json_schema_extra={"is_config": False},
        description="Collection of operational rstp bridge attributes",
        default=None,
        alias="rstp-bridge-attr",
    )
    rstp_bridge_port_state_attr: RstpBridgePortStateAttr | None = Field(
        json_schema_extra={"is_config": False},
        description="Collection of operational rstp port related attributes",
        default=None,
        alias="rstp-bridge-port-state-attr",
    )
...
class RstpBridgeInstanceItem(YangBaseModel):
    ...
    rstp_config: RstpConfig | None = Field(
        json_schema_extra={"is_config": True},
        description="Collection of rstp configuration attributes",
        default=None,
        alias="rstp-config",
    )
    rstp_state: RstpState | None = Field(
        json_schema_extra={"is_config": False},
        description="Collection of rstp operational attributes",
        default=None,
        alias="rstp-state",
    )
...
class Rstp(YangBaseModel):
    ...
    rstp_bridge_instance: RestconfList[RstpBridgeInstanceItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="rstp bridge instance, max instance = 4",
        default=None,
        alias="rstp-bridge-instance",
    )
...
class Protocols(YangBaseModel):
    ...
    rstp: Rstp | None = Field(
        json_schema_extra={"is_config": True}, description="Open ROADM RSTP top level", default=None
    )
...
class Ne(YangBaseModel):
    ...
    ne_id: str | None = Field(
        json_schema_extra={"is_config": True},
        description="Network Element's system identification code.\nNote that this is unique identifier for each NE.",
        min_length=0,
        max_length=256,
        default="",
        alias="ne-id",
    ...
    ne_type: str | None = Field(
        json_schema_extra={"is_config": False}, description="Type of the NE", default="GROOVE_G30", alias="ne-type"
    )
    ...
    ne_temperature: Decimal64 | None = Field(
        json_schema_extra={"is_config": False},
        description="Ambient temperature sensed by the primary shelf for NE level",
        default=None,
        alias="ne-temperature",
    )
    shelf: RestconfList[ShelfItem] | None = Field(json_schema_extra={"is_config": True}, default=None)
    inventory_data: InventoryData | None = Field(
        json_schema_extra={"is_config": False},
        description="Simple container for the inventory list",
        default=None,
        alias="inventory-data",
    )
    leds: Leds | None = Field(
        json_schema_extra={"is_config": False}, description="Simple container for the led list.", default=None
    )
    services: Services | None = Field(json_schema_extra={"is_config": True}, default=None)
    fault: Fault | None = Field(
        json_schema_extra={"is_config": True}, description="fault management MO, always exist", default=None
    )
    performance: Performance | None = Field(
        json_schema_extra={"is_config": True},
        description="Container for all PM-Points and for PM related attributes",
        default=None,
    )
    system: SystemSystem | None = Field(
        json_schema_extra={"is_config": True},
        description="Container with the part of the model with is related with the whole System",
        default=None,
    )
...
class NeData(YangBaseModel):
    ...
    ne: Ne | None = Field(
        json_schema_extra={"is_config": True},
        description="Root of the Managed Entity hierarchy, represents the whole Network Element",
        default=None,
        alias="ne:ne",
    )
...
class ChangedBy(YangBaseModel):
    ...
    session_id: Annotated[str, AfterValidator(lambda v: check_pattern("^(?:[0-9A-Fa-f.:]*)$", v))] | None = Field(
        json_schema_extra={"is_config": None},
