...
if TYPE_CHECKING:
    from orchestrator.optical.services.nokia.g42.data_navigators import (
        ioa_alarm,
        ioa_network_element,
        ioa_pm,
        ioa_protection,
...
class Data(Node):
    ...
    def user_data(self) -> ioa_user_data.UserDataNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_user_data import UserDataNode
    ...
    def ne(self) -> ioa_network_element.NeNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_network_element import NeNode

        return NeNode(self._client, f"{self._path}/ioa-network-element:ne", "ioa-network-element:ne")

    @property
    def pm(self) -> ioa_pm.PmNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_pm import PmNode

        return PmNode(self._client, f"{self._path}/ioa-pm:pm", "ioa-pm:pm")

    @property
    def alarms(self) -> ioa_alarm.AlarmsNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_alarm import AlarmsNode
...
class Operations(Node):
    ...
    def clear_app(self) -> ioa_rpc.ClearAppNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearAppNode
    ...
    def clear_database(self) -> ioa_rpc.ClearDatabaseNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearDatabaseNode
    ...
    def kill_session(self) -> ioa_rpc.KillSessionNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import KillSessionNode
    ...
    def clear_certificate(self) -> ioa_rpc.ClearCertificateNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearCertificateNode

        return ClearCertificateNode(
            self._client, f"{self._path}/ioa-rpc:clear-certificate", "ioa-rpc:clear-certificate"
        )

    @property
    def display_cert(self) -> ioa_rpc.DisplayCertNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import DisplayCertNode
    ...
    def clear_crl(self) -> ioa_rpc.ClearCrlNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearCrlNode
    ...
    def ssh_keygen(self) -> ioa_rpc.SshKeygenNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import SshKeygenNode
    ...
    def cert_gen(self) -> ioa_rpc.CertGenNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import CertGenNode

        return CertGenNode(self._client, f"{self._path}/ioa-rpc:cert-gen", "ioa-rpc:cert-gen")

    @property
    def csr_gen(self) -> ioa_rpc.CsrGenNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import CsrGenNode

        return CsrGenNode(self._client, f"{self._path}/ioa-rpc:csr-gen", "ioa-rpc:csr-gen")

    @property
    def diff(self) -> ioa_rpc.DiffNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import DiffNode

        return DiffNode(self._client, f"{self._path}/ioa-rpc:diff", "ioa-rpc:diff")

    @property
    def cli_command(self) -> ioa_rpc.CliCommandNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import CliCommandNode
    ...
    def install_krp(self) -> ioa_rpc.InstallKrpNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import InstallKrpNode
    ...
    def delete_isk(self) -> ioa_rpc.DeleteIskNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import DeleteIskNode

        return DeleteIskNode(self._client, f"{self._path}/ioa-rpc:delete-isk", "ioa-rpc:delete-isk")

    @property
    def get_log(self) -> ioa_rpc.GetLogNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import GetLogNode

        return GetLogNode(self._client, f"{self._path}/ioa-rpc:get-log", "ioa-rpc:get-log")

    @property
    def clear_log(self) -> ioa_rpc.ClearLogNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearLogNode
    ...
    def change_ztp_mode(self) -> ioa_rpc.ChangeZtpModeNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ChangeZtpModeNode
    ...
    def enable_led(self) -> ioa_rpc.EnableLedNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import EnableLedNode
    ...
    def disable_led(self) -> ioa_rpc.DisableLedNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import DisableLedNode
    ...
    def profile_control(self) -> ioa_rpc.ProfileControlNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ProfileControlNode
    ...
    def start_otdr_measurement(self) -> ioa_rpc.StartOtdrMeasurementNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import StartOtdrMeasurementNode

        return StartOtdrMeasurementNode(
            self._client, f"{self._path}/ioa-rpc:start-otdr-measurement", "ioa-rpc:start-otdr-measurement"
        )

    @property
    def stop_otdr_measurement(self) -> ioa_rpc.StopOtdrMeasurementNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import StopOtdrMeasurementNode

        return StopOtdrMeasurementNode(
            self._client, f"{self._path}/ioa-rpc:stop-otdr-measurement", "ioa-rpc:stop-otdr-measurement"
        )

    @property
    def stop_cable_id(self) -> ioa_rpc.StopCableIdNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import StopCableIdNode
    ...
    def clear_ospf_instance(self) -> ioa_rpc.ClearOspfInstanceNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearOspfInstanceNode

        return ClearOspfInstanceNode(
            self._client, f"{self._path}/ioa-rpc:clear-ospf-instance", "ioa-rpc:clear-ospf-instance"
        )

    @property
    def clear_topology(self) -> ioa_rpc.ClearTopologyNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearTopologyNode
    ...
    def clear_system(self) -> ioa_rpc.ClearSystemNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearSystemNode
    ...
    def download(self) -> ioa_rpc.DownloadNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import DownloadNode

        return DownloadNode(self._client, f"{self._path}/ioa-rpc:download", "ioa-rpc:download")

    @property
    def upload(self) -> ioa_rpc.UploadNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import UploadNode
    ...
    def import_certificate(self) -> ioa_rpc.ImportCertificateNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ImportCertificateNode

        return ImportCertificateNode(
            self._client, f"{self._path}/ioa-rpc:import-certificate", "ioa-rpc:import-certificate"
        )

    @property
    def prepare_upgrade(self) -> ioa_rpc.PrepareUpgradeNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import PrepareUpgradeNode
    ...
    def activate_file(self) -> ioa_rpc.ActivateFileNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ActivateFileNode
    ...
    def cancel_upgrade(self) -> ioa_rpc.CancelUpgradeNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import CancelUpgradeNode
    ...
    def set_time(self) -> ioa_rpc.SetTimeNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import SetTimeNode

        return SetTimeNode(self._client, f"{self._path}/ioa-rpc:set-time", "ioa-rpc:set-time")

    @property
    def password(self) -> ioa_rpc.PasswordNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import PasswordNode
    ...
    def clear_recover_mode(self) -> ioa_rpc.ClearRecoverModeNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearRecoverModeNode

        return ClearRecoverModeNode(
            self._client, f"{self._path}/ioa-rpc:clear-recover-mode", "ioa-rpc:clear-recover-mode"
        )

    @property
    def run_task(self) -> ioa_rpc.RunTaskNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import RunTaskNode
    ...
    def take_snapshot(self) -> ioa_rpc.TakeSnapshotNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import TakeSnapshotNode
    ...
    def get_script(self) -> ioa_rpc.GetScriptNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import GetScriptNode
    ...
    def run_script(self) -> ioa_rpc.RunScriptNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import RunScriptNode
    ...
    def manual_switchover(self) -> ioa_rpc.ManualSwitchoverNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ManualSwitchoverNode

        return ManualSwitchoverNode(
            self._client, f"{self._path}/ioa-rpc:manual-switchover", "ioa-rpc:manual-switchover"
        )

    @property
    def file_operation(self) -> ioa_rpc.FileOperationNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import FileOperationNode
    ...
    def call_home(self) -> ioa_rpc.CallHomeNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import CallHomeNode
    ...
    def activate_fw(self) -> ioa_rpc.ActivateFwNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ActivateFwNode

        return ActivateFwNode(self._client, f"{self._path}/ioa-rpc:activate-fw", "ioa-rpc:activate-fw")

    @property
    def re_key(self) -> ioa_rpc.ReKeyNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ReKeyNode

        return ReKeyNode(self._client, f"{self._path}/ioa-rpc:re-key", "ioa-rpc:re-key")

    @property
    def re_auth(self) -> ioa_rpc.ReAuthNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ReAuthNode
    ...
    def clear_diagnostics(self) -> ioa_rpc.ClearDiagnosticsNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ClearDiagnosticsNode

        return ClearDiagnosticsNode(
            self._client, f"{self._path}/ioa-rpc:clear-diagnostics", "ioa-rpc:clear-diagnostics"
        )

    @property
    def get_file(self) -> ioa_rpc.GetFileNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import GetFileNode
    ...
    def apply_template(self) -> ioa_rpc.ApplyTemplateNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ApplyTemplateNode
    ...
    def bert(self) -> ioa_rpc.BertNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import BertNode

        return BertNode(self._client, f"{self._path}/ioa-rpc:bert", "ioa-rpc:bert")

    @property
    def db_migrate(self) -> ioa_rpc.DbMigrateNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import DbMigrateNode

        return DbMigrateNode(self._client, f"{self._path}/ioa-rpc:db-migrate", "ioa-rpc:db-migrate")

    @property
    def status(self) -> ioa_rpc.StatusNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import StatusNode

        return StatusNode(self._client, f"{self._path}/ioa-rpc:status", "ioa-rpc:status")

    @property
    def config(self) -> ioa_rpc.ConfigNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import ConfigNode
    ...
    def get_possible_values(self) -> ioa_rpc.GetPossibleValuesNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import GetPossibleValuesNode

        return GetPossibleValuesNode(
            self._client, f"{self._path}/ioa-rpc:get-possible-values", "ioa-rpc:get-possible-values"
        )

    @property
    def get_default(self) -> ioa_rpc.GetDefaultNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import GetDefaultNode
    ...
    def display_access(self) -> ioa_rpc.DisplayAccessNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import DisplayAccessNode
    ...
    def get_commit(self) -> ioa_rpc.GetCommitNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import GetCommitNode
    ...
    def rollback(self) -> ioa_rpc.RollbackNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import RollbackNode
    ...
    def auto_discovery(self) -> ioa_rpc.AutoDiscoveryNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_rpc import AutoDiscoveryNode
    ...
    def create_xcon(self) -> ioa_services.CreateXconNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_services import CreateXconNode
    ...
    def get_pm(self) -> ioa_pm.GetPmNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_pm import GetPmNode

        return GetPmNode(self._client, f"{self._path}/ioa-pm:get-pm", "ioa-pm:get-pm")

    @property
    def clear_pm(self) -> ioa_pm.ClearPmNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_pm import ClearPmNode
    ...
    def protection_switch(self) -> ioa_protection.ProtectionSwitchNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_protection import ProtectionSwitchNode

        return ProtectionSwitchNode(
            self._client, f"{self._path}/ioa-protection:protection-switch", "ioa-protection:protection-switch"
        )

    @property
    def set_alarm_state(self) -> ioa_alarm.SetAlarmStateNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_alarm import SetAlarmStateNode
    ...
    def clear_alarm(self) -> ioa_alarm.ClearAlarmNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_alarm import ClearAlarmNode
    ...
    def get_conditions(self) -> ioa_alarm.GetConditionsNode:
        from orchestrator.optical.services.nokia.g42.data_navigators.ioa_alarm import GetConditionsNode
