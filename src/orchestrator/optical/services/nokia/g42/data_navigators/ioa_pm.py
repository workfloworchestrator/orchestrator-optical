...
class PmResourceItemNode(ItemNode):
    ...
    def pm_control_entry(self) -> PmControlEntryListNode:
        return PmControlEntryListNode(
            self._client, f"{self._path}/pm-control-entry", "pm-control-entry", PmControlEntryItemNode
        )
...
class PmProfileEntryItemNode(ItemNode):
    ...
    def pm_threshold_profile(self) -> PmThresholdProfileListNode:
        return PmThresholdProfileListNode(
            self._client, f"{self._path}/pm-threshold-profile", "pm-threshold-profile", PmThresholdProfileItemNode
        )
...
class PmProfileNode(Node):
    ...
    def pm_profile_entry(self) -> PmProfileEntryListNode:
        return PmProfileEntryListNode(
            self._client, f"{self._path}/pm-profile-entry", "pm-profile-entry", PmProfileEntryItemNode
        )
