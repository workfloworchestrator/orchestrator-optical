...
class AlarmSeverityProfileNode(Node):
    ...
    def alarm_severity_entry(self) -> AlarmSeverityEntryListNode:
        return AlarmSeverityEntryListNode(
            self._client, f"{self._path}/alarm-severity-entry", "alarm-severity-entry", AlarmSeverityEntryItemNode
        )
...
class AlarmsNode(Node):
    ...
    def alarm_inventory(self) -> AlarmInventoryListNode:
        return AlarmInventoryListNode(
            self._client, f"{self._path}/alarm-inventory", "alarm-inventory", AlarmInventoryItemNode
        )
