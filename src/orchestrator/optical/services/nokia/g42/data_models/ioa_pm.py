...
class RealTimePmItem(YangBaseModel):
    ...
    parameter: str = Field(
        json_schema_extra={"is_config": False}, description="PM parameter identifier (can be a counter or a gauge)."
    )
...
class RealTimePmData(YangBaseModel):
    ...
    real_time_pm: RestconfList[RealTimePmItem] | None = Field(
        json_schema_extra={"is_config": False},
...
class CurrentPmItem(YangBaseModel):
    ...
    validity: ValidityEnum | None = Field(
        json_schema_extra={"is_config": False}, description="PM parameter validity.", default=None
    )
...
class CurrentPmData(YangBaseModel):
    ...
    current_pm: RestconfList[CurrentPmItem] | None = Field(
        json_schema_extra={"is_config": False},
...
class HistoryPmData(YangBaseModel):
    ...
    history_pm: RestconfList[HistoryPmItem] | None = Field(
        json_schema_extra={"is_config": False},
...
class PmThresholdItem(YangBaseModel):
    ...
    parameter: str = Field(
        json_schema_extra={"is_config": True}, description="PM parameter identifier (can be a counter or a gauge)."
    )
    low_threshold: int | float | str | None = Field(
    ...
    high_threshold: int | float | str | None = Field(
        json_schema_extra={"is_config": True},
...
class PmControlEntryItem(YangBaseModel):
    ...
    supported_parameters: RestconfList[str] | None = Field(
        json_schema_extra={"is_config": False},
        description="List of PM parameters that this resource type supports for this direction/location.",
        default=None,
        alias="supported-parameters",
    )
    data_supervision: bool | None = Field(
        json_schema_extra={"is_config": True},
        description="PM data supervision for this resource.",
        default=None,
        alias="data-supervision",
    )
    tca_supervision: bool | None = Field(
        json_schema_extra={"is_config": True},
        description="TCA supervision for this resource.",
        default=None,
        alias="tca-supervision",
    )
    pm_threshold: RestconfList[PmThresholdItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class PmResourceItem(YangBaseModel):
    ...
    real_time_supervision: bool | None = Field(
        json_schema_extra={"is_config": True},
        description="Real-time data supervision for this resource.",
        default=True,
        alias="real-time-supervision",
    )
    real_time_data_last_reset: (
        Annotated[
            str,
            AfterValidator(
                lambda v: check_pattern(
        ...
        json_schema_extra={"is_config": False},
        description="Date and time of the last real time data reset for this resource. If the data was never reset, this is the date and time of this resource's creation.",
        default=None,
        alias="real-time-data-last-reset",
    )
    pm_control_entry: RestconfList[PmControlEntryItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="PM configuration for one particular resource, for one particular period, direction and location.",
        default=None,
        alias="pm-control-entry",
    )
...
class PmControl(YangBaseModel):
    ...
    pm_resource: RestconfList[PmResourceItem] | None = Field(
        json_schema_extra={"is_config": True},
...
class PmThresholdProfileItem(YangBaseModel):
    ...
    default_low_threshold: int | float | str | None = Field(
        json_schema_extra={"is_config": False},
        description="System defined default value for low threshold for this parameter.",
        default=None,
        alias="default-low-threshold",
    )
    default_high_threshold: int | float | str | None = Field(
        json_schema_extra={"is_config": False},
        description="System defined default value for high threshold for this parameter.",
        default=None,
        alias="default-high-threshold",
    )
    min_value: int | float | str | None = Field(
        json_schema_extra={"is_config": False},
        description="Minimum value for this parameter.",
        default=None,
        alias="min-value",
    )
    max_value: int | float | str | None = Field(
        json_schema_extra={"is_config": False},
...
class PmProfile(YangBaseModel):
    ...
    global_data_supervision: GlobalDataSupervisionEnum | None = Field(
        json_schema_extra={"is_config": True},
        description="This parameter provides a way to globally enable PM data-supervision without having to toggle it individually.",
        default=GlobalDataSupervisionEnum.MANUAL,
        alias="global-data-supervision",
    )
    pm_profile_entry: RestconfList[PmProfileEntryItem] | None = Field(
        json_schema_extra={"is_config": True},
        description="PM configuration per resource type.",
        default=None,
        alias="pm-profile-entry",
    )
...
class PmParameterItem(YangBaseModel):
    ...
    units: PmUnitTypeEnum | None = Field(
        json_schema_extra={"is_config": False}, description="Units for this parameter.", default=None
    )
...
class PmCatalog(YangBaseModel):
    ...
    pm_parameter: RestconfList[PmParameterItem] | None = Field(
        json_schema_extra={"is_config": False},
...
class Pm(YangBaseModel):
    ...
    real_time_pm_data: RealTimePmData | None = Field(
        json_schema_extra={"is_config": False},
        description="Container for real-time-pm entries.",
        default=None,
        alias="real-time-pm-data",
    )
    current_pm_data: CurrentPmData | None = Field(
        json_schema_extra={"is_config": False},
        description="Container for current-pm entries.",
        default=None,
        alias="current-pm-data",
    )
    history_pm_data: HistoryPmData | None = Field(
        json_schema_extra={"is_config": False},
        description="Container for history-pm entries.",
        default=None,
        alias="history-pm-data",
    )
    pm_control: PmControl | None = Field(
        json_schema_extra={"is_config": True},
        description="Configuration for currently existing resources in the system that support PM data.",
        default=None,
        alias="pm-control",
    )
    pm_profile: PmProfile | None = Field(
        json_schema_extra={"is_config": True},
    ...
    pm_catalog: PmCatalog | None = Field(
        json_schema_extra={"is_config": False},
...
class FilterItem(YangBaseModel):
    ...
    direction: DirectionEnum | None = Field(
        json_schema_extra={"is_config": None}, description="PM parameter direction.", default=DirectionEnum.ALL
    )
    location: LocationEnum | None = Field(
        json_schema_extra={"is_config": None}, description="PM parameter location.", default=LocationEnum.ALL
    )
...
class PmRecordItem(YangBaseModel):
    ...
    parameter: str = Field(
        json_schema_extra={"is_config": None}, description="PM parameter identifier (can be a counter or a gauge)."
    )
    ...
    validity: ValidityEnum | None = Field(
        json_schema_extra={"is_config": None}, description="PM parameter validity.", default=None
    )
    bin: int = Field(
        json_schema_extra={"is_config": None},
        description="Bin number of history PM. Most recent bins have lowest numbers.",
...
class GetPmInput(YangBaseModel):
    ...
    data_type: DataTypeEnum | None = Field(
        ...
        default=DataTypeEnum.REAL_TIME,
        alias="data-type",
    )
    period: str | None = Field(
        json_schema_extra={"is_config": None},
        description="Time period for PM data.\n\nCondition (when): data-type != 'real-time'",
        default=None,
    )
    reset_data: bool | None = Field(
        json_schema_extra={"is_config": None},
        description="If true, clear the corresponding PM data after the request has been issued. This is only applicable to real-time PM.\n\nCondition (when): ../data-type = 'real-time'",
        default=False,
        alias="reset-data",
    )
    number_of_records: int | None = Field(
        json_schema_extra={"is_config": None},
        description="Maximum number of records that will be retrieved, per chassis.",
        ge=0,
        le=10000,
        default=1000,
        alias="number-of-records",
    )
    skip_records: int | None = Field(
        json_schema_extra={"is_config": None},
    ...
    chassis_scope: str | None = Field(
        json_schema_extra={"is_config": None},
        description="Chassis scope of command.",
        default="all",
        alias="chassis-scope",
    )
...
class GetPmOutput(YangBaseModel):
    ...
    number_of_result_records: int | None = Field(
        json_schema_extra={"is_config": None},
        description="Counter of the number of pm-records included in this response.\nNote: in a multi-chassis system, this reflects the value from the node controller chassis alone.",
        ge=0,
        default=None,
        alias="number-of-result-records",
    )
    additional_records_available: bool | None = Field(
        json_schema_extra={"is_config": None},
        ...
        default=False,
        alias="additional-records-available",
    )
    retrieval_date_time: (
        Annotated[
            str,
        ...
        default=None,
        alias="retrieval-date-time",
    )
    pm_record: RestconfList[PmRecordItem] | None = Field(
        json_schema_extra={"is_config": None},
...
class ClearPmInput(YangBaseModel):
    ...
    data_type: DataTypeEnum = Field(
        json_schema_extra={"is_config": None}, description="Type of PM data to clear.", alias="data-type"
    )
    period: str | None = Field(
        json_schema_extra={"is_config": None},
        description="Time period for PM data.\n\nCondition (when): data-type != 'real-time'",
