...
"""RTRV-SYS command for Nokia FlexILS nodes."""
...
class SysResponse(TL1BaseResponse):
    """Response model for the RTRV-SYS command."""

    def rename_positional_params(self, parsed_data: list[dict[str, Any]]) -> list[dict[str, Any]]:
        """RTRV-SYS responses carry only key=value parameters, nothing to rename."""
        return parsed_data
...
class RetrieveSys(TL1BaseCommand):
    ...
    response_class: ClassVar[type[TL1BaseResponse]] = SysResponse
